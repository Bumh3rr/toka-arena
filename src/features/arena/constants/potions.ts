...
export const POTIONS_META: Record<PotionId, Potion> = {
  ...
  PURIFICATION_TONIC: {
    ...
    image: `${BASE}/purification_tonic.svg`,
    tint: "#9D74D6",
    price: 15,
    limitPerBattle: 1,
  },
