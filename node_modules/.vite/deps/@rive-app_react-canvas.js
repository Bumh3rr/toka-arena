...
//#region node_modules/@rive-app/canvas/rive.js
var require_rive = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		return (() => {
			...
			var __webpack_modules__ = [
				...
				((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					...
					__webpack_require__.d(__webpack_exports__, { Animation: () => _Animation__WEBPACK_IMPORTED_MODULE_0__.Animation });
					var _Animation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
				}),
				((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					__webpack_require__.r(__webpack_exports__);
					__webpack_require__.d(__webpack_exports__, { Animation: () => Animation });
					/**
				...
				((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					__webpack_require__.r(__webpack_exports__);
					__webpack_require__.d(__webpack_exports__, { RuntimeLoader: () => RuntimeLoader });
					var _rive_advanced_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
					var package_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
					...
					var RuntimeLoader = function() {
						...
						RuntimeLoader.notifyError = function(error) {
							...
							while (RuntimeLoader.errorCallbackQueue.length > 0) (_a = RuntimeLoader.errorCallbackQueue.shift()) === null || _a === void 0 || _a(error);
						...
						RuntimeLoader.loadRuntime = function() {
							...
							_rive_advanced_mjs__WEBPACK_IMPORTED_MODULE_0__["default"](__assign({ locateFile: function() {
								return attemptedUrl;
						...
						RuntimeLoader.getInstance = function(callback, onError) {
							...
							if (!RuntimeLoader.runtime) {
								...
								if (onError) RuntimeLoader.errorCallbackQueue.push(onError);
				...
				((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
					...
					const __WEBPACK_DEFAULT_EXPORT__ = (() => {
						...
						return async function(moduleArg = {}) {
							var moduleRtn;
							var k = moduleArg, aa = !!globalThis.window, ca = !!globalThis.WorkerGlobalScope;
							function da() {
								function a(g) {
									const h = d;
									c = b = 0;
							...
							k.onRuntimeInitialized = function() {
								...
								k.CustomFileAssetLoader = e.extend("CustomFileAssetLoader", {
									__construct: function({ loadContents: g }) {
								...
								k.CDNFileAssetLoader = e.extend("CDNFileAssetLoader", {
									__construct: function(g) {
										this.__parent.__construct.call(this);
										this.Vc = g ?? null;
									},
								...
								k.FallbackFileAssetLoader = e.extend("FallbackFileAssetLoader", {
									...
									loadContents: function(g, h) {
										for (let l of this.wc) if (l.loadContents(g, h)) return !0;
										return !1;
									}
								});
							...
							const ia = "createConicGradient createImageData createLinearGradient createPattern createRadialGradient getContextAttributes getImageData getLineDash getTransform isContextLost isPointInPath isPointInStroke measureText".split(" "), ja = new function() {
								function a() {
									if (!b) {
										...
										if (/iPhone|iPad|iPod/i.test(navigator.userAgent)) {
											if (p = x.getContext("webgl", y), c = 1, !p) return console.log("No WebGL support. Image mesh will not be drawn."), !1;
										...
										p = new Proxy(p, {
											get(J, v) {
												if (J.isContextLost()) {
													if (l || (console.error("Cannot render the mesh because the GL Context was lost. Tried to invoke ", v), l = !0), "function" === typeof J[v]) return function() {};
												} else return "function" === typeof J[v] ? function(...N) {
													return J[v].apply(J, N);
												} : J[v];
											},
											set(J, v, N) {
												if (J.isContextLost()) l || (console.error("Cannot render the mesh because the GL Context was lost. Tried to set property " + v), l = !0);
												else return J[v] = N, !0;
											}
										});
										...
										x = p.createProgram();
										H(x, p.VERTEX_SHADER, "attribute vec2 vertex;\n                attribute vec2 uv;\n                uniform vec4 mat;\n                uniform vec2 translate;\n                varying vec2 st;\n                void main() {\n                    st = uv;\n                    gl_Position = vec4(mat2(mat) * vertex + translate, 0, 1);\n                }");
								...
								let b = null, c = 0, d = 0, e = null, f = null, g = 0, h = 0, l = !1;
								a();
								this.td = function() {
									a();
									return d;
								...
								this.cd = function(x, y, p, H, J) {
									if (a()) {
										...
										if (b.canvas) {
											...
											p.sort((G, ha) => ha.Ic - G.Ic);
											v = u.push(H);
											g != v && (b.bufferData(b.ARRAY_BUFFER, 8 * v, b.DYNAMIC_DRAW), g = v);
											v = 0;
											for (var O of p) b.bufferSubData(b.ARRAY_BUFFER, v, O.ec), v += 4 * O.ec.length;
											console.assert(v == 4 * H);
											for (var V of p) b.bufferSubData(b.ARRAY_BUFFER, v, V.Mc), v += 4 * V.Mc.length;
											console.assert(v == 8 * H);
											v = r.push(J);
											h != v && (b.bufferData(b.ELEMENT_ARRAY_BUFFER, 2 * v, b.DYNAMIC_DRAW), h = v);
											O = 0;
											for (var ba of p) b.bufferSubData(b.ELEMENT_ARRAY_BUFFER, O, ba.indices), O += 2 * ba.indices.length;
											console.assert(O == 2 * J);
											ba = 0;
											V = !0;
											v = O = 0;
											for (const G of p) {
												G.image.Tb != ba && (b.bindTexture(b.TEXTURE_2D, G.image.Rb || null), ba = G.image.Tb);
												G.xd ? (b.scissor(G.mc, N - G.nc - G.vc, G.Gd, G.vc), V = !0) : V && (b.scissor(0, N - y, x, y), V = !1);
												p = 2 / x;
												const ha = -2 / y;
												b.uniform4f(e, G.lb[0] * p * G.Gb, G.lb[1] * ha * G.Hb, G.lb[2] * p * G.Gb, G.lb[3] * ha * G.Hb);
												b.uniform2f(f, G.lb[4] * p * G.Gb + p * (G.mc - G.ud * G.Gb) - 1, G.lb[5] * ha * G.Hb + ha * (G.nc - G.vd * G.Hb) + 1);
												b.vertexAttribPointer(0, 2, b.FLOAT, !1, 0, v);
												b.vertexAttribPointer(1, 2, b.FLOAT, !1, 0, v + 4 * H);
												b.drawElements(b.TRIANGLES, G.indices.length, b.UNSIGNED_SHORT, O);
												v += 4 * G.ec.length;
							...
							k.onRuntimeInitialized = function() {
								function a(m) {
									switch (m) {
										case n.srcOver: return "source-over";
										case n.screen: return "screen";
										case n.overlay: return "overlay";
										case n.darken: return "darken";
										case n.lighten: return "lighten";
										case n.colorDodge: return "color-dodge";
										case n.colorBurn: return "color-burn";
										case n.hardLight: return "hard-light";
										case n.softLight: return "soft-light";
										case n.difference: return "difference";
										case n.exclusion: return "exclusion";
										case n.multiply: return "multiply";
										case n.hue: return "hue";
										case n.saturation: return "saturation";
										case n.color: return "color";
										case n.luminosity: return "luminosity";
									}
								}
								function b(m) {
								...
								function c() {
									0 < V.length && (ja.cd(O.drawWidth(), O.drawHeight(), V, ba, G), V = [], G = ba = 0, O.reset(512, 512));
									for (const m of v) {
										for (const q of m.Oa) q();
										m.Oa = [];
									}
									v.clear();
								}
								...
								let x = 1;
								var y = k.RenderImage.extend("CanvasRenderImage", {
									__construct: function({ sb: m, Eb: q } = {}) {
										this.__parent.__construct.call(this);
										this.Tb = x;
										x = x + 1 & 2147483647 || 1;
										this.sb = m;
									...
									__destruct: function() {
										this.Rb && (ja.$c(this.Rb), URL.revokeObjectURL(this.kc));
									...
									decode: function(m) {
										...
										q.Eb && q.Eb(q);
										var B = new Image();
										q.kc = URL.createObjectURL(new Blob([m], { type: "image/png" }));
										B.onload = function() {
											q.Sc = B;
											q.Rb = ja.Zc(B);
											q.size(B.width, B.height);
											q.sb && q.sb(q);
										};
										B.src = q.kc;
									}
								...
								class p {
									...
									Wc(m) {
										for (0 < this.Kb && this.cb < m.length && this.clear(); this.cb < m.length;) m[this.cb++](this.Za);
										this.Kb++;
										return this.Za;
									}
									release(m) {
								...
								var H = e.extend("CanvasRenderPath", {
									__construct: function() {
										this.__parent.__construct.call(this);
										this.Pb = [];
										this.Za = new p();
									...
									addPath: function(m, q, B, z, K, C, D) {
										const A = m.Oc();
										this.ob((I) => {
									...
									cubicTo: function(m, q, B, z, K, C) {
										this.ic();
										this.Mb();
										this.ob((D) => {
											D.bezierCurveTo(m, q, B, z, K, C);
										});
									},
									close: function() {
										this.Mb();
									...
									ic: function() {
										this.Ob || this.moveTo(0, 0);
									},
									Mb: function() {
										null !== this.pb && (this.pb.pc = !1, this.pb = null);
									},
									ob: function(m) {
										this.Pb.push(m);
									},
									Lb: function() {
										return this.Za.Wc(this.Pb);
									},
									lc: function(m) {
										this.Za.release(m);
									},
								...
								}), J = f.extend("CanvasRenderPaint", {
									__construct: function() {
										this.__parent.__construct.call(this);
										this.Ma = [];
										this.Nb = 0;
										this.Qb = t;
										this.Ub = b(4278190080);
										this.Sb = 1;
										this.xb = "miter";
										this.wb = "butt";
										this.fc = a(n.srcOver);
									...
									Pc: function(m, q, B, z) {
										if (this.Qb !== u || 0 < this.Sb) {
											var K = this.Qb, C = this.Ub, D = this.kb, A = m.globalCompositeOperation, I = m.globalAlpha;
											m.globalCompositeOperation = this.fc;
											m.globalAlpha = z;
											if (null != D) {
												C = D.Jc;
												const R = D.Kc, U = D.rc;
												var L = D.sc;
												z = D.dc;
												D.rd ? (D = U - C, L -= R, C = m.createRadialGradient(C, R, 0, C, R, Math.sqrt(D * D + L * L))) : C = m.createLinearGradient(C, R, U, L);
												for (let W = 0, Pa = z.length; W < Pa; W++) D = z[W], C.addColorStop(D.stop, b(D.color));
												this.Ub = C;
												this.kb = null;
											}
											switch (K) {
												case u:
													...
													m.stroke(q);
													break;
												case t: m.fillStyle = C, m.fill(q, B);
											}
									...
									Rc: function() {
										return this.Nb + this.Ma.length;
									},
									Qc: function(m) {
										const q = m - this.Nb;
										for (let B = 0; B < q; B++) this.Ma[B]();
										this.Ma.splice(0, q);
										this.Nb = m;
									}
								});
								const v = /* @__PURE__ */ new Set(), N = Object.prototype.hasOwnProperty;
								let O = null, V = [], ba = 0, G = 0;
								var ha = k.CanvasRenderer = g.extend("Renderer", {
									__construct: function(m) {
										...
										this.Ka = [1];
										this.Ia = m.getContext("2d");
										this.hc = m;
										this.Oa = [];
									},
									save: function() {
										this.Ya.push(...this.Ya.slice(this.Ya.length - 6));
										this.Ka.push(this.Ka[this.Ka.length - 1]);
										this.Oa.push(this.Ia.save.bind(this.Ia));
									},
									restore: function() {
										const m = this.Ya.length - 6;
										if (6 > m) throw "restore() called without matching save().";
										this.Ya.splice(m);
										this.Ka.pop();
										this.Oa.push(this.Ia.restore.bind(this.Ia));
									},
									transform: function(m, q, B, z, K, C) {
										const D = this.Ya, A = D.length - 6;
										D.splice(A, 6, D[A] * m + D[A + 2] * q, D[A + 1] * m + D[A + 3] * q, D[A] * B + D[A + 2] * z, D[A + 1] * B + D[A + 3] * z, D[A] * K + D[A + 2] * C + D[A + 4], D[A + 1] * K + D[A + 3] * C + D[A + 5]);
										this.Oa.push(this.Ia.transform.bind(this.Ia, m, q, B, z, K, C));
									},
									rotate: function(m) {
										const q = Math.sin(m);
										m = Math.cos(m);
									...
									modulateOpacity: function(m) {
										this.Ka[this.Ka.length - 1] *= m;
									},
									_drawPath: function(m, q) {
										const B = m.jc === r ? "evenodd" : "nonzero", z = Math.max(0, this.Ka[this.Ka.length - 1]), K = m.Lb(), C = q.Rc();
										this.Oa.push(() => {
											q.Qc(C);
											q.Pc(this.Ia, K, B, z);
											m.lc(K);
									...
									_drawRiveImage: function(m, q, B) {
										var z = m.Sc;
										if (z) {
											var K = this.Ia, C = a(q), D = Math.max(0, B * this.Ka[this.Ka.length - 1]);
											this.Oa.push(function() {
												K.globalCompositeOperation = C;
												K.globalAlpha = D;
												K.drawImage(z, 0, 0);
												K.globalAlpha = 1;
											});
									...
									_getMatrix: function(m) {
										const q = this.Ya, B = q.length - 6;
										for (let z = 0; 6 > z; ++z) m[z] = q[B + z];
									},
									_drawImageMesh: function(m, q, B, z, K, C, D, A, I, L, R, U, W) {
										let Pa, Rb, Sb;
										try {
											Pa = k.HEAPF32.slice(z >> 2, (z >> 2) + K), Rb = k.HEAPF32.slice(C >> 2, (C >> 2) + D), Sb = k.HEAPU16.slice(A >> 1, (A >> 1) + I);
										} catch (hb) {
											console.error("[Rive] _drawImageMesh: failed to read mesh data from WASM heap. Mesh skipped for this frame.");
											return;
										}
										z = this.Ia.canvas.width;
										C = this.Ia.canvas.height;
										D = U - L;
										A = W - R;
										L = Math.max(L, 0);
										R = Math.max(R, 0);
										...
										W = Math.min(W, C);
										const Ca = U - L, Da = W - R;
										console.assert(Ca <= Math.min(D, z));
										console.assert(Da <= Math.min(A, C));
										if (!(0 >= Ca || 0 >= Da)) {
											U = Ca < D || Da < A;
											z = W = 1;
											var oa = Math.ceil(Ca * W), pa = Math.ceil(Da * z);
											C = ja.td();
											oa > C && (W *= C / oa, oa = C);
											pa > C && (z *= C / pa, pa = C);
											O || (O = new k.DynamicRectanizer(C), O.reset(512, 512));
											C = O.addRect(oa, pa);
											0 > C && (c(), v.add(this), C = O.addRect(oa, pa), console.assert(0 <= C));
											var Tb = C & 65535, Ub = C >> 16;
											V.push({
												lb: this.Ya.slice(this.Ya.length - 6),
												image: m,
												mc: Tb,
												nc: Ub,
												ud: L,
											...
											ba += K;
											G += I;
											var ua = this.Ia, Vc = a(q), Wc = Math.max(0, B * this.Ka[this.Ka.length - 1]);
											this.Oa.push(function() {
												ua.save();
												ua.resetTransform();
												ua.globalCompositeOperation = Vc;
												ua.globalAlpha = Wc;
												const hb = ja.canvas();
												hb && ua.drawImage(hb, Tb, Ub, oa, pa, L, R, Ca, Da);
												ua.restore();
											});
										}
									},
									_clipPath: function(m) {
										const q = m.jc === r ? "evenodd" : "nonzero", B = m.Lb();
										this.Oa.push(() => {
											this.Ia.clip(B, q);
											m.lc(B);
										});
									},
									beginFrame: function(m = !0) {
										v.add(this);
										m && this.Oa.push(this.Ia.clearRect.bind(this.Ia, 0, 0, this.hc.width, this.hc.height));
									},
									clear: function() {
										this.beginFrame(!0);
									},
								...
								k.makeRenderer = function(m) {
									const q = new ha(m), B = q.Ia;
									let z = null, K = null;
									const C = {
										attachSession: function(A) {
											if (A && z === A) return !0;
											if (!A || z || "function" !== typeof k.c2dDeferredClaim || "function" !== typeof k.c2dDeferredRenderer || !k.c2dDeferredClaim(A)) return !1;
											const I = k.c2dDeferredRenderer(A);
											if (!I) return !1;
											z = A;
											K = I;
											return !0;
										...
										transform: function(A, I, L, R, U, W) {
											k.c2dDeferredTransform(z, A, I, L, R, U, W);
										},
										translate: function(A, I) {
											k.c2dDeferredTransform(z, 1, 0, 0, 1, A, I);
										},
										rotate: function(A) {
											const I = Math.sin(A);
											A = Math.cos(A);
											k.c2dDeferredTransform(z, A, I, -I, A, 0, 0);
										},
										align: function(A, I, L, R, U) {
											k.c2dDeferredAlign(z, A, I, L.minX, L.minY, L.maxX, L.maxY, R.minX, R.minY, R.maxX, R.maxY, void 0 === U ? 1 : U);
										},
										beginFrame: function(A = !0) {
											q.beginFrame(A);
										...
										flush: function() {
											k.c2dDeferredReplay(z, q);
										}
									};
									return new Proxy(q, {
										get(A, I) {
											if (N.call(C, I)) return C[I];
											if ("_deferredRecorder" === I) return K;
											if (null !== K && N.call(D, I)) return D[I];
											if ("function" === typeof A[I]) return function(...L) {
												return A[I].apply(A, L);
											};
											if ("function" === typeof B[I]) {
												if (-1 < ia.indexOf(I)) throw Error("RiveException: Method call to '" + I + "()' is not allowed, as the renderer cannot immediately pass through the return                 values of any canvas 2d context methods.");
												return function(...L) {
													q.Oa.push(B[I].bind(B, ...L));
												};
											}
											return A[I];
										},
										set(A, I, L) {
											if (I in B) return q.Oa.push(() => {
												B[I] = L;
											}), !0;
										}
									});
								...
								let Xc = k.load, ib = null;
								k.load = function(m, q, B = !0, z = null) {
									const K = new k.FallbackFileAssetLoader();
									void 0 !== q && K.addLoader(q);
									B && (q = new k.CDNFileAssetLoader(z), K.addLoader(q));
								...
								const Yc = k.Artboard.prototype.draw;
								k.Artboard.prototype.draw = function(m) {
									Yc.call(this, m._deferredRecorder || m);
								};
								let Zc = k.RendererWrapper.prototype.align;
								k.RendererWrapper.prototype.align = function(m, q, B, z, K = 1) {
									Zc.call(this, m, q, B, z, K);
								};
								d = new da();
								k.requestAnimationFrame = d.requestAnimationFrame.bind(d);
								k.cancelAnimationFrame = d.cancelAnimationFrame.bind(d);
								k.enableFPSCounter = d.dd.bind(d);
								k.disableFPSCounter = d.ad;
								d.Bc = c;
							...
							if (aa || ca) {
								...
								na = async (a) => {
									if (ra(a)) return new Promise((c, d) => {
							...
							var sa = console.log.bind(console), ta = console.error.bind(console), va, wa = !1, xa, ra = (a) => a.startsWith("file://"), ya, za, w, E, Aa, Ba, F, M, Ea, Fa, Ga, Ha, Ia = !1;
							function Ja() {
								var a = Ka.buffer;
								k.HEAP8 = w = new Int8Array(a);
								Aa = new Int16Array(a);
								k.HEAPU8 = E = new Uint8Array(a);
								k.HEAPU16 = Ba = new Uint16Array(a);
								k.HEAP32 = F = new Int32Array(a);
								k.HEAPU32 = M = new Uint32Array(a);
								k.HEAPF32 = Ea = new Float32Array(a);
								Fa = new Float64Array(a);
								Ga = new BigInt64Array(a);
							...
							async function Na(a) {
								...
								if (a == Ma && va) a = new Uint8Array(va);
								else if (qa) a = qa(a);
							...
							async function Oa(a, b) {
								try {
									...
									ta(`failed to asynchronously prepare wasm: ${d}`), La(d);
								}
							}
							async function Qa(a) {
								var b = Ma;
							...
							var pb = {
								...
								read(a, b, c, d) {
									if (!a.Ca || !a.Ca.bb.uc) throw new P(60);
									for (var e = 0, f = 0; f < d; f++) {
										try {
											var g = a.Ca.bb.uc(a.Ca);
										} catch (h) {
											throw new P(29);
										}
									...
									e && (a.node.ib = Date.now());
									return e;
								},
								write(a, b, c, d) {
									if (!a.Ca || !a.Ca.bb.ac) throw new P(60);
									try {
										for (var e = 0; e < d; e++) a.Ca.bb.ac(a.Ca, b[c + e]);
									} catch (f) {
										throw new P(29);
									}
									d && (a.node.Sa = a.node.Pa = Date.now());
									return e;
								}
							}, qb = {
								uc() {
								...
								createNode(a, b, c, d) {
									...
									c.ib = c.Sa = c.Pa = Date.now();
									a && (a.ya[b] = c, a.ib = a.Sa = a.Pa = c.ib);
									return c;
								},
								Vd(a) {
									return a.ya ? a.ya.subarray ? a.ya.subarray(0, a.Ga) : new Uint8Array(a.ya) : new Uint8Array(0);
								},
								za: {
									gb(a) {
										var b = {};
										b.Sd = 8192 === (a.mode & 61440) ? a.id : 1;
										b.Xd = a.id;
										b.mode = a.mode;
										b.Zd = 1;
										b.uid = 0;
										b.Wd = 0;
										b.Fb = a.Fb;
										16384 === (a.mode & 61440) ? b.size = 4096 : 32768 === (a.mode & 61440) ? b.size = a.Ga : 40960 === (a.mode & 61440) ? b.size = a.link.length : b.size = 0;
										b.ib = new Date(a.ib);
										b.Sa = new Date(a.Sa);
										b.Pa = new Date(a.Pa);
										b.Xc = 4096;
										b.Md = Math.ceil(b.size / b.Xc);
										return b;
									},
									Xa(a, b) {
										for (var c of [
										...
										void 0 !== b.size && (b = b.size, a.Ga != b && (0 == b ? (a.ya = null, a.Ga = 0) : (c = a.ya, a.ya = new Uint8Array(b), c && a.ya.set(c.subarray(0, Math.min(b, a.Ga))), a.Ga = b)));
									},
									rb() {
										Q.Vb || (Q.Vb = new P(44), Q.Vb.stack = "<generic error, no stack>");
										throw Q.Vb;
									},
									Cb(a, b, c, d) {
									...
									Fc(a, b, c) {
										...
										if (d) {
											if (16384 === (a.mode & 61440)) for (var e in d.ya) throw new P(55);
										...
										b.ya[c] = a;
										a.name = c;
										b.Pa = b.Sa = a.parent.Pa = a.parent.Sa = Date.now();
									},
									Lc(a, b) {
										delete a.ya[b];
										a.Pa = a.Sa = Date.now();
								...
								xa: {
									...
									write(a, b, c, d, e, f) {
										...
										if (b.subarray && (!a.ya || a.ya.subarray)) {
											...
											if (0 === a.Ga && 0 === e) return a.ya = b.slice(c, c + d), a.Ga = d;
											if (e + d <= a.Ga) return a.ya.set(b.subarray(c, c + d), e), d;
										}
										f = e + d;
										var g = a.ya ? a.ya.length : 0;
										g >= f || (f = Math.max(f, g * (1048576 > g ? 2 : 1.125) >>> 0), 0 != g && (f = Math.max(f, 256)), g = a.ya, a.ya = new Uint8Array(f), 0 < a.Ga && a.ya.set(g.subarray(0, a.Ga), 0));
										if (a.ya.subarray && b.subarray) a.ya.set(b.subarray(c, c + d), e);
										else for (f = 0; f < d; f++) a.ya[e + f] = b[c + f];
										a.Ga = Math.max(a.Ga, e + d);
										return d;
									},
									Ua(a, b, c) {
										1 === c ? b += a.position : 2 === c && 32768 === (a.node.mode & 61440) && (b += a.node.Ga);
								...
								b && (c |= 146);
								return c;
							}, yb = null, zb = {}, Ab = [], Bb = 1, wb = null, Cb = !1, Db = !0, Eb = {}, P = class {
								name = "ErrnoError";
								constructor(a) {
									this.eb = a;
								}
								...
								constructor(a, b, c, d) {
									...
									this.mode = c;
									this.Fb = d;
									this.ib = this.Sa = this.Pa = Date.now();
								}
								get read() {
									...
									for (var d = yb, e = "/", f = 0; f < a.length; f++) {
										...
										if ("." !== a[f]) if (".." === a[f]) if (e = ab(e), d === d.parent) {
											...
											try {
												...
												if (44 === h?.eb && g && b.yd) return { path: e };
												throw h;
											}
											!d.Db || g && !b.Xb || (d = d.Db.root);
											if (40960 === (d.mode & 61440) && (!g || b.Wb)) {
												if (!d.za.tb) throw new P(52);
												d = d.za.tb(d);
												"/" === d.charAt(0) || (d = ab(e) + "/" + d);
							...
							function ub(a, b) {
								var c = 16384 === (a.mode & 61440) ? (c = Ib(a, "x")) ? c : a.za.rb ? 0 : 2 : 54;
								if (c) throw new P(c);
								for (c = wb[vb(a.id, b)]; c; c = c.mb) {
									var d = c.name;
							...
							function Pb(a, b) {
								...
								a.ab = b;
								b.root = a;
								c ? yb = a : d && (d.Db = b, d.ab && d.ab.wd.push(b));
							}
							function Qb(a, b, c) {
								...
								var e = Kb(d, a);
								if (e) throw new P(e);
								if (!d.za.Cb) throw new P(63);
								return d.za.Cb(d, a, b, c);
							}
							function Vb(a) {
								return Qb(a, 16895, 0);
							}
							...
							function Yb(a, b, c = 438) {
								...
								if (b & 512 && !f) {
									e = d;
									e = "string" == typeof e ? Hb(e, { Wb: !0 }).node : e;
								...
								f && (c &= 511, d = "string" == typeof d ? Hb(d, { Wb: !0 }).node : d, Ob(d, {
							...
							function Zb(a, b, c) {
								if (null === a.fb) throw new P(8);
								if (!a.seekable || !a.xa.Ua) throw new P(70);
								if (0 != c && 1 != c && 2 != c) throw new P(28);
								a.position = a.xa.Ua(a, b, c);
								a.Fd = [];
							}
							function $b(a, b, c) {
								a = $a("/dev/" + a);
								...
								ob(e, {
									...
									write(f, g, h, l) {
										...
										l && (f.node.Sa = f.node.Pa = Date.now());
										return n;
									}
								});
								Wb(a, d, e);
							}
							var ac = {}, Xa = void 0, bc = (a, b) => Object.defineProperty(b, "name", { value: a }), cc = [], dc = [
								0,
								1,
								,
								1,
							...
							var T = (a) => {
								...
								pc = new FinalizationRegistry((b) => {
									b = b.va;
									--b.count.value;
									0 === b.count.value && (b.Ja ? b.Qa.Wa(b.Ja) : b.Da.wa.Wa(b.Ba));
								});
								qc = (b) => {
									var c = b.va;
							...
							var yc = (a, b, c) => {
								switch (b) {
									case 1: return c ? (d) => w[d] : (d) => E[d];
									case 2: return c ? (d) => Aa[d >> 1] : (d) => Ba[d >> 1];
									case 4: return c ? (d) => F[d >> 2] : (d) => M[d >> 2];
									case 8: return c ? (d) => Ga[d >> 3] : (d) => Ha[d >> 3];
									default: throw new TypeError(`invalid integer width (${b}): ${a}`);
								}
							}, zc = (a) => {
								throw new S(a.va.Da.wa.name + " instance already deleted");
							}, Ac = [];
							function Bc() {}
							var Cc = {}, Dc = (a, b, c) => {
								if (void 0 === a[b].Fa) {
									var d = a[b];
									a[b] = function(...e) {
										if (!a[b].Fa.hasOwnProperty(e.length)) throw new S(`Function '${c}' called with an invalid number of arguments (${e.length}) - expects one of (${a[b].Fa})!`);
								...
								if (k.hasOwnProperty(a)) {
									if (void 0 === c || void 0 !== k[a].Fa && void 0 !== k[a].Fa[c]) throw new S(`Cannot register public name '${a}' twice`);
									Dc(k, a, a);
									if (k[a].Fa.hasOwnProperty(c)) throw new S(`Cannot register multiple overloads of a function with the same number of arguments (${c})!`);
									k[a].Fa[c] = b;
								} else k[a] = b, k[a].$a = c;
							}, Fc = (a) => {
							...
							var Hc = (a, b, c) => {
								for (; b !== c;) {
									if (!b.ub) throw new S(`Expected null or instance of ${c.name}, got an instance of ${b.name}`);
									a = b.ub(a);
									b = b.Ha;
								}
								return a;
							...
							function Jc(a, b) {
								if (null === b) {
									if (this.Zb) throw new S(`null is not a valid ${this.name}`);
									return 0;
								}
								if (!b.va) throw new S(`Cannot pass "${Ic(b)}" as a ${this.name}`);
								if (!b.va.Ba) throw new S(`Cannot pass deleted object as a pointer of type ${this.name}`);
							...
							function Kc(a, b) {
								if (null === b) {
									...
									if (this.Bb) {
										var c = this.bc();
										null !== a && a.push(this.Wa, c);
										return c;
									}
									return 0;
								}
								if (!b || !b.va) throw new S(`Cannot pass "${Ic(b)}" as a ${this.name}`);
								if (!b.va.Ba) throw new S(`Cannot pass deleted object as a pointer of type ${this.name}`);
								if (!this.Ab && b.va.Da.Ab) throw new S(`Cannot convert argument of type ${b.va.Qa ? b.va.Qa.name : b.va.Da.name} to parameter type ${this.name}`);
								c = Hc(b.va.Ba, b.va.Da.wa, this.wa);
								if (this.Bb) {
									if (void 0 === b.va.Ja) throw new S("Passing raw pointer to smart pointer is illegal");
									switch (this.Ed) {
										case 0:
											if (b.va.Qa === this) c = b.va.Ja;
											else throw new S(`Cannot convert argument of type ${b.va.Qa ? b.va.Qa.name : b.va.Da.name} to parameter type ${this.name}`);
											break;
										case 1:
											c = b.va.Ja;
											break;
										case 2:
											if (b.va.Qa === this) c = b.va.Ja;
												...
												var d = b.clone();
												c = this.Ad(c, fc(() => d["delete"]()));
												null !== a && a.push(this.Wa, c);
											}
											break;
										default: throw new S("Unsupported sharing policy");
									}
								}
								return c;
							}
							function Lc(a, b) {
								...
								if (!b.va) throw new S(`Cannot pass "${Ic(b)}" as a ${this.name}`);
								if (!b.va.Ba) throw new S(`Cannot pass deleted object as a pointer of type ${this.name}`);
								if (b.va.Da.Ab) throw new S(`Cannot convert argument of type ${b.va.Da.name} to parameter type ${this.name}`);
								return Hc(b.va.Ba, b.va.Da.wa, this.wa);
							}
							var Mc = (a, b, c) => {
								if (b === c) return a;
								...
								a = Mc(a, b, c.Ha);
								return null === a ? null : c.bd(a);
							}, Nc = (a, b) => {
								b = ic(a, b);
								return hc[b];
							}, Oc = (a, b) => {
								if (!b.Da || !b.Ba) throw new wc("makeClassHandle requires ptr and ptrType");
								if (!!b.Qa !== !!b.Ja) throw new wc("Both smartPtrType and smartPtr must be specified");
								b.count = { value: 1 };
								return qc(Object.create(a, { va: {
									value: b,
									writable: !0
								} }));
							};
							function Pc(a, b, c, d, e, f, g, h, l, n, t) {
								this.name = a;
								this.wa = b;
								this.Zb = c;
								this.Ab = d;
								...
								this.Ad = n;
								this.Wa = t;
								e || void 0 !== b.Ha ? this.Ea = Kc : (this.Ea = d ? Jc : Lc, this.La = null);
							}
							var Qc = (a, b, c) => {
								if (!k.hasOwnProperty(a)) throw new wc("Replacing nonexistent public symbol");
								void 0 !== k[a].Fa && void 0 !== c ? k[a].Fa[c] = b : (k[a] = b, k[a].$a = c);
							}, Z = (a, b) => {
								a = T(a);
								var c = Rc.get(b);
							...
							var Tc = (a, b) => {
								function c(f) {
									e[f] || jc[f] || (vc[f] ? vc[f].forEach(c) : (d.push(f), e[f] = !0));
								}
								var d = [], e = {};
								b.forEach(c);
							...
							function $c(a, b, c, d, e) {
								...
								var g = null !== b[1] && null !== c, h = Uc(b), l = !b[0].sd, n = f - 2, t = Array(n), u = [], r = [];
								return bc(a, function(...x) {
									...
									for (var p = 0; p < n; ++p) t[p] = b[p + 2].Ea(r, x[p]), u.push(t[p]);
									x = d(...u);
									if (h) sc(r);
							...
							var ad = (a, b) => {
								for (var c = [], d = 0; d < a; d++) c.push(M[b + 4 * d >> 2]);
								return c;
							}, bd = (a) => {
								a = a.trim();
								const b = a.indexOf("(");
								...
								if (!(a instanceof b.wa.constructor)) throw new S(`${c} incompatible with "this" of type ${a.constructor.name}`);
								if (!a.va.Ba) throw new S(`cannot call emscripten binding method ${c} on deleted object`);
								...
								switch (b) {
									...
									case 2: return c ? function(d) {
										return this.Aa(Aa[d >> 1]);
									} : function(d) {
										return this.Aa(Ba[d >> 1]);
									};
									case 4: return c ? function(d) {
										return this.Aa(F[d >> 2]);
									} : function(d) {
										return this.Aa(M[d >> 2]);
									};
									default: throw new TypeError(`invalid integer width (${b}): ${a}`);
								}
							}, gd = (a, b) => {
								switch (b) {
									case 4: return function(c) {
										return this.Aa(Ea[c >> 2]);
									};
									case 8: return function(c) {
										return this.Aa(Fa[c >> 3]);
									};
									default: throw new TypeError(`invalid float width (${b}): ${a}`);
								}
							}, hd = globalThis.TextDecoder ? new TextDecoder("utf-16le") : void 0, jd = (a, b, c) => {
								a >>= 1;
								b = fb(Ba, a, b / 2, c);
								if (16 < b - a && hd) return hd.decode(Ba.subarray(a, b));
								for (c = ""; a < b; ++a) c += String.fromCharCode(Ba[a]);
								return c;
							}, kd = (a, b, c) => {
								c ??= 2147483647;
								if (2 > c) return 0;
								...
								for (var c = Array(a), d = 0; d < a; ++d) c[d] = nc(M[b + 4 * d >> 2], `parameter ${d}`);
								return c;
							}, td = {}, ud = (a) => {
								var b = td[a];
								...
								if (!Dd) {
									...
									for (b in Cd) void 0 === Cd[b] ? delete a[b] : a[b] = Cd[b];
									var c = [];
							...
							(() => {
								...
								Object.assign(a, {
									isAliasOf: function(c) {
										...
										var d = this.va.Da.wa, e = this.va.Ba;
										c.va = c.va;
										var f = c.va.Da.wa;
										for (c = c.va.Ba; d.Ha;) e = d.ub(e), d = d.Ha;
										for (; f.Ha;) c = f.ub(c), f = f.Ha;
										return d === f && e === c;
									},
									clone: function() {
										this.va.Ba || zc(this);
										if (this.va.nb) return this.va.count.value += 1, this;
										var c = qc, d = Object, e = d.create, f = Object.getPrototypeOf(this), g = this.va;
										c = c(e.call(d, f, { va: { value: {
											count: g.count,
											qb: g.qb,
											nb: g.nb,
											Ba: g.Ba,
									...
									["delete"]() {
										this.va.Ba || zc(this);
										if (this.va.qb && !this.va.nb) throw new S("Object already scheduled for deletion");
										oc(this);
										var c = this.va;
										--c.count.value;
										0 === c.count.value && (c.Ja ? c.Qa.Wa(c.Ja) : c.Da.wa.Wa(c.Ba));
										this.va.nb || (this.va.Ja = void 0, this.va.Ba = void 0);
									},
									isDeleted: function() {
										return !this.va.Ba;
									},
							...
							Object.assign(Pc.prototype, {
								...
								Aa: function(a) {
									...
									var d = Nc(this.wa, c);
									if (void 0 !== d) {
										if (0 === d.va.count.value) return d.va.Ba = c, d.va.Ja = a, d.clone();
										d = d.clone();
										this.qc(a);
										return d;
									}
									...
									d = this.Ab ? d.Yc : d.pointerType;
									var e = Mc(c, this.wa, d.wa);
									return null === e ? b.call(this) : this.Bb ? Oc(d.wa.Ta, {
										Da: d,
										Ba: e,
										Qa: this,
										Ja: a
							...
							var Id = {
									...
									if ("undefined" === typeof window.miniaudio) {
										...
										f.unlock = function() {
											for (var g = 0; g < f.devices.length; ++g) {
												var h = f.devices[g];
												null != h && null != h.Ra && h.state === f.device_state.started && h.Ra.resume().then(() => {
													Fd(h.Cc);
												}, (l) => {
											...
											f.unlock_event_types.map(function(l) {
												document.removeEventListener(l, f.unlock, !0);
											});
										};
								...
								242897: () => void 0 !== navigator.mediaDevices && void 0 !== navigator.mediaDevices.getUserMedia,
								243001: () => {
									try {
								...
								243172: (a, b, c, d, e, f) => {
									...
									g.Ra = new (window.AudioContext || window.webkitAudioContext)(h);
									g.Ra.suspend();
									g.state = window.miniaudio.device_state.stopped;
									c = 0;
									a != window.miniaudio.device_type.playback && (c = b);
									g.hb = g.Ra.createScriptProcessor(d, c, b);
									g.hb.onaudioprocess = function(l) {
										if (null == g.zb || 0 == g.zb.length) g.zb = new Float32Array(Ea.buffer, e, d * b);
										if (a == window.miniaudio.device_type.capture || a == window.miniaudio.device_type.duplex) {
											for (var n = 0; n < b; n += 1) for (var t = l.inputBuffer.getChannelData(n), u = g.zb, r = 0; r < d; r += 1) u[r * b + n] = t[r];
											Gd(f, d, e);
										}
										if (a == window.miniaudio.device_type.playback || a == window.miniaudio.device_type.duplex) for (Hd(f, d, e), n = 0; n < l.outputBuffer.numberOfChannels; ++n) for (t = l.outputBuffer.getChannelData(n), u = g.zb, r = 0; r < d; r += 1) t[r] = u[r * b + n];
										else for (n = 0; n < l.outputBuffer.numberOfChannels; ++n) l.outputBuffer.getChannelData(n).fill(0);
									};
									a != window.miniaudio.device_type.capture && a != window.miniaudio.device_type.duplex || navigator.mediaDevices.getUserMedia({
										audio: !0,
										video: !1
									}).then(function(l) {
										g.Ib = g.Ra.createMediaStreamSource(l);
										g.Ib.connect(g.hb);
										g.hb.connect(g.Ra.destination);
									}).catch(function(l) {
										console.log("Failed to get user media: " + l);
									});
									a == window.miniaudio.device_type.playback && g.hb.connect(g.Ra.destination);
									g.Cc = f;
									return window.miniaudio.track_device(g);
								},
								246049: (a) => window.miniaudio.get_device_by_index(a).Ra.sampleRate,
								246122: (a) => {
									a = window.miniaudio.get_device_by_index(a);
									void 0 !== a.hb && (a.hb.onaudioprocess = function() {}, a.hb.disconnect(), a.hb = void 0);
									void 0 !== a.Ib && (a.Ib.disconnect(), a.Ib = void 0);
									a.Ra.close();
									a.Ra = void 0;
									a.Cc = void 0;
								},
							...
							}, lc, Jd, kc, Fd, Gd, Hd, Kd, Ld, Md, Nd, Ka, Rc, Pd = {
								s: function(a, b, c) {
									Xa = c;
									try {
										var d = Lb(a);
										switch (b) {
											...
											case 4: return e = Ya(), d.flags |= e, 0;
											case 12: return e = Ya(), Aa[e + 0 >> 1] = 2, 0;
											case 13:
											case 14: return 0;
										}
										return -28;
										...
										switch (b) {
											...
											case 21505:
												...
												if (d.Ca.bb.od) {
													...
													F[e + 8 >> 2] = 191;
													F[e + 12 >> 2] = 35387;
													for (var f = 0; 32 > f; f++) w[e + f + 17] = a[f] || 0;
												}
												return 0;
											case 21510:
											case 21511:
											case 21512: return d.Ca ? 0 : -59;
											case 21506:
											case 21507:
											case 21508:
												if (!d.Ca) return -59;
												if (d.Ca.bb.pd) for (e = Ya(), a = [], f = 0; 32 > f; f++) a.push(w[e + f + 17]);
												return 0;
											case 21519:
												if (!d.Ca) return -59;
												e = Ya();
												return F[e >> 2] = 0;
											case 21520: return d.Ca ? -28 : -59;
											case 21537:
											case 21531:
												e = Ya();
												if (!d.xa.nd) throw new P(59);
												return d.xa.nd(d, b, e);
											case 21523:
												if (!d.Ca) return -59;
												d.Ca.bb.qd && (f = [24, 80], e = Ya(), Aa[e >> 1] = f[0], Aa[e + 2 >> 1] = f[1]);
												return 0;
											case 21524: return d.Ca ? 0 : -59;
											case 21515: return d.Ca ? 0 : -59;
											default: return -28;
										}
									} catch (g) {
								...
								o: (a, b, c) => {
									...
									b = nc(b, "wrapper");
									c = ec(c);
									var d = b.wa, e = d.Ta, f = d.Ha.Ta, g = d.Ha.constructor;
									a = bc(a, function(...h) {
										for (var l of d.Ha.Dc) if (this[l] === f[l]) throw new gc(`Pure virtual function ${l} must be implemented in JavaScript`);
									...
									e.__construct = function(...h) {
										...
										l.nb = !0;
										Object.defineProperties(this, { va: { value: l } });
										qc(this);
										h = l.Ba;
										h = ic(d, h);
								...
								_: (a) => {
									var b = rc[a];
									delete rc[a];
									var c = b.bc, d = b.Wa, e = b.tc, f = e.map((g) => g.ld).concat(e.map((g) => g.Cd));
									Y([a], f, (g) => {
										var h = {}, l, n;
										for ([l, n] of e.entries()) {
											const t = g[l], u = n.jd, r = n.kd, x = g[l + e.length], y = n.Bd, p = n.Dd;
											h[n.ed] = {
												read: (H) => t.Aa(u(r, H)),
												write: (H, J) => {
													var v = [];
								...
								c: (a, b, c, d, e, f, g, h, l, n, t, u, r) => {
									...
									var x = Fc(t);
									Ec(x, function() {
										Tc(`Cannot construct ${t} due to unbound types`, [d]);
									});
									Y([
										a,
										b,
										...
										y = bc(t, function(...O) {
											if (Object.getPrototypeOf(this) !== J) throw new S(`Use 'new' to construct ${t}`);
											if (void 0 === v.jb) throw new S(`${t} has no accessible constructor`);
											var V = v.jb[O.length];
											if (void 0 === V) throw new S(`Tried to invoke ctor of ${t} with invalid number of parameters (${O.length}) - expected (${Object.keys(v.jb).toString()}) parameters instead!`);
											return V.apply(this, O);
										});
										var J = Object.create(H, { constructor: { value: y } });
										y.prototype = J;
										var v = new Gc(t, y, J, r, p, f, h, n);
										if (v.Ha) {
											var N;
											(N = v.Ha).vb ?? (N.vb = []);
											v.Ha.vb.push(v);
								...
								k: (a, b, c, d, e, f, g) => {
									...
									Y([], [a], (l) => {
										function n() {
											Tc(`Cannot call ${t} due to unbound types`, h);
										}
										l = l[0];
										var t = `${l.name}.${b}`;
										b.startsWith("@@") && (b = Symbol[b.substring(2)]);
										var u = l.wa.constructor;
										void 0 === u[b] ? (n.$a = c - 1, u[b] = n) : (Dc(u, b, t), u[b].Fa[c - 1] = n);
										Y([], h, (r) => {
											r = $c(t, [r[0], null].concat(r.slice(1)), null, f, g);
											void 0 === u[b].Fa ? (r.$a = c - 1, u[b] = r) : u[b].Fa[c - 1] = r;
											if (l.wa.vb) for (const x of l.wa.vb) x.constructor.hasOwnProperty(b) || (x.constructor[b] = r);
											return [];
										});
										return [];
									});
								...
								q: (a, b, c, d, e, f, g, h) => {
									...
									Y([], [a], (l) => {
										...
										var n = `${l.name}.${b}`, t = {
											get() {
												Tc(`Cannot access ${n} due to unbound types`, [c]);
											},
											enumerable: !0,
											configurable: !0
										};
										...
										Object.defineProperty(l.wa.constructor, b, t);
										Y([], [c], (u) => {
											u = u[0];
											var r = {
												get() {
											...
											Object.defineProperty(l.wa.constructor, b, r);
											return [];
										});
										return [];
									});
								...
								n: (a, b, c, d, e, f) => {
									...
									Y([], [a], (h) => {
										...
										void 0 === h.wa.jb && (h.wa.jb = []);
										if (void 0 !== h.wa.jb[b - 1]) throw new S(`Cannot register multiple constructors with identical number of parameters (${b - 1}) for class '${h.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
										h.wa.jb[b - 1] = () => {
											Tc(`Cannot construct ${h.name} due to unbound types`, g);
										};
										Y([], g, (n) => {
											n.splice(1, 0, null);
											h.wa.jb[b - 1] = $c(l, n, null, e, f);
											return [];
										});
										return [];
									});
								...
								a: (a, b, c, d, e, f, g, h) => {
									...
									Y([], [a], (n) => {
										function t() {
											Tc(`Cannot call ${u} due to unbound types`, l);
										}
										n = n[0];
										var u = `${n.name}.${b}`;
										b.startsWith("@@") && (b = Symbol[b.substring(2)]);
										h && n.wa.Dc.push(b);
										var r = n.wa.Ta, x = r[b];
										void 0 === x || void 0 === x.Fa && x.className !== n.name && x.$a === c - 2 ? (t.$a = c - 2, t.className = n.name, r[b] = t) : (Dc(r, b, u), r[b].Fa[c - 2] = t);
										Y([], l, (y) => {
											y = $c(u, y, n, f, g);
											void 0 === r[b].Fa ? (y.$a = c - 2, r[b] = y) : r[b].Fa[c - 2] = y;
											return [];
										});
										return [];
									});
								},
								b: (a, b, c, d, e, f, g, h, l, n) => {
									b = T(b);
									e = Z(d, e);
									Y([], [a], (t) => {
										t = t[0];
										var u = `${t.name}.${b}`, r = {
											get() {
												Tc(`Cannot access ${u} due to unbound types`, [c, g]);
											},
											enumerable: !0,
											configurable: !0
										};
										r.set = l ? () => Tc(`Cannot access ${u} due to unbound types`, [c, g]) : () => {
											throw new S(u + " is a read-only property");
										};
										Object.defineProperty(t.wa.Ta, b, r);
										Y([], l ? [c, g] : [c], (x) => {
											var y = x[0], p = {
												get() {
													var J = cd(this, t, u + " getter");
													return y.Aa(e(f, J));
												},
												enumerable: !0
											};
											if (l) {
												...
												var H = x[1];
												p.set = function(J) {
													var v = cd(this, t, u + " setter"), N = [];
													l(n, v, H.Ea(N, J));
													sc(N);
												};
											}
											Object.defineProperty(t.wa.Ta, b, p);
											return [];
										});
										return [];
									});
								...
								d: (a, b, c) => {
									...
									switch (d.valueType) {
										...
										case "number":
											d.$b[b] = c;
											break;
										case "string": d.Nc[b] = c, d.Gc[c] = b, d.$b[b] = b;
									}
								},
								t: (a, b, c) => {
									b = T(b);
								...
								g: (a, b, c, d, e, f) => {
									...
									Y([], g, (h) => {
										Qc(a, $c(a, [h[0], null].concat(h.slice(1)), null, e, f), b - 1);
										return [];
									});
								},
								l: (a, b, c, d, e) => {
								...
								i: (a, b, c) => {
									function d(f) {
										return new e(w.buffer, M[f + 4 >> 2], M[f >> 2]);
									}
									var e = [
										Int8Array,
										Uint8Array,
								...
								U: (a, b) => {
									...
									X(a, {
										...
										Ea(c, d) {
											...
											var g = Jd(4 + f + 1), h = g + 4;
											M[g >> 2] = f;
											e ? lb(d, E, h, f + 1) : E.set(d, h);
											null !== c && c.push(lc, g);
											return g;
										},
										Na: tc,
								...
								f: (a, b, c) => {
									var [d, ...e] = sd(a, b), f = d.Ea.bind(d), g = e.map((l) => l.Na.bind(l));
									a--;
									var h = Array(a);
									b = `methodCaller<(${e.map((l) => l.name)}) => ${d.name}>`;
									return rd(bc(b, (l, n, t, u) => {
								...
								E: function(a, b) {
									...
									F[b + 24 >> 2] = a.getDay();
									var c = a.getFullYear();
									F[b + 28 >> 2] = (0 !== c % 4 || 0 === c % 100 && 0 !== c % 400 ? wd : vd)[a.getMonth()] + a.getDate() - 1 | 0;
								...
								B: (a, b) => {
									xd[a] && (clearTimeout(xd[a].id), delete xd[a]);
									if (!b) return 0;
									xd[a] = {
										id: setTimeout(() => {
											delete xd[a];
											Ad(() => Kd(a, performance.now()));
										}, b),
										be: b
									};
									return 0;
								...
								F: (a, b, c, d) => {
									...
									a = b(f);
									b = b(e);
									e < f ? (lb(a, E, c, 17), lb(b, E, d, 17)) : (lb(a, E, d, 17), lb(b, E, c, 17));
								},
								O: function(a, b, c) {
									if (!(0 <= a && 3 >= a)) return 28;
									Ga[c >> 3] = BigInt(Math.round(1e6 * (0 === a ? Date.now() : performance.now())));
									return 0;
								},
								j: (a, b, c) => {
									Bd.length = 0;
									for (var d; d = E[b++];) {
										...
										e &= 112 != d;
										c += e && c % 8 ? 4 : 0;
										Bd.push(112 == d ? M[c >> 2] : 106 == d ? Ga[c >> 3] : 105 == d ? F[c >> 2] : Fa[c >> 3]);
										c += e ? 8 : 4;
									}
									return Id[a](...Bd);
								},
								...
								G: function(a, b, c, d) {
									...
									try {
										...
										var e = Lb(a);
										Zb(e, b, c);
										Ga[d >> 3] = BigInt(e.position);
										e.Yb && 0 === b && 0 === c && (e.Yb = null);
										return 0;
									} catch (f) {
										if ("undefined" == typeof ac || "ErrnoError" !== f.name) throw f;
										return f.eb;
									...
									try {
										a: {
											...
											for (var f, g = b = 0; g < c; g++) {
												...
												if (16384 === (n.node.mode & 61440)) throw new P(31);
												if (!n.xa.write) throw new P(28);
												n.seekable && n.flags & 1024 && Zb(n, 0, 2);
												var y = "undefined" != typeof r;
												if (!y) r = n.position;
												else if (!n.seekable) throw new P(70);
												var p = n.xa.write(n, x, t, u, r, void 0);
												y || (n.position += p);
												var H = p;
												if (0 > H) {
													var J = -1;
								...
								z: zd,
								S: function(a, b, c) {
									b = new Uint8Array(Ka.buffer, b, c);
									c = new Uint8Array(c);
									c.set(b);
									createImageBitmap(new Blob([c])).then(function(d) {
										...
										var f = e.data.length, g = k.Uc(f);
										k.Hd.set(e.data, g);
										k.Jd(a, d.width, d.height, g, f);
									}).catch(function(d) {
										d = d.message || "decode failed";
										var e = k.Yd(d) + 1, f = k.Uc(e);
										k.ae(d, f, e);
										k.Kd(a, f);
										k.Id(f);
									});
							...
							var Qd = await async function() {
								function a(c) {
									...
									Fd = k._ma_device__on_notification_unlocked = c.la;
									k._ma_malloc_emscripten = c.ma;
									k._ma_free_emscripten = c.na;
									Gd = k._ma_device_process_pcm_frames_capture__webaudio = c.oa;
									Hd = k._ma_device_process_pcm_frames_playback__webaudio = c.pa;
									Kd = c.ra;
									Ld = c.sa;
									Md = c.ta;
									Nd = c.ua;
								...
								Ma ??= k.locateFile ? k.locateFile("canvas_advanced.wasm", ma) : ma + "canvas_advanced.wasm";
							...
							Ia ? moduleRtn = k : moduleRtn = new Promise((a, b) => {
								ya = a;
								za = b;
							});
							return moduleRtn;
				...
				((module$1) => {
					module$1.exports = /* @__PURE__ */ JSON.parse("{\"name\":\"@rive-app/canvas\",\"version\":\"2.42.0\",\"description\":\"Rive's canvas based web api.\",\"main\":\"rive.js\",\"homepage\":\"https://rive.app\",\"repository\":{\"type\":\"git\",\"url\":\"https://github.com/rive-app/rive-wasm/tree/master/js\"},\"keywords\":[\"rive\",\"animation\"],\"author\":\"Rive\",\"contributors\":[\"Luigi Rosso <luigi@rive.app> (https://rive.app)\",\"Maxwell Talbot <max@rive.app> (https://rive.app)\",\"Arthur Vivian <arthur@rive.app> (https://rive.app)\",\"Umberto Sonnino <umberto@rive.app> (https://rive.app)\",\"Matthew Sullivan <matt.j.sullivan@gmail.com> (mailto:matt.j.sullivan@gmail.com)\"],\"license\":\"MIT\",\"files\":[\"rive.js\",\"rive.js.map\",\"rive.wasm\",\"rive_fallback.wasm\",\"rive.d.ts\",\"rive_advanced.mjs.d.ts\",\"runtimeLoader.d.ts\",\"utils\",\"semantics\"],\"typings\":\"rive.d.ts\",\"dependencies\":{},\"browser\":{\"fs\":false,\"path\":false}}");
				}),
				((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					__webpack_require__.r(__webpack_exports__);
					__webpack_require__.d(__webpack_exports__, {
						AccessibilityOverlay: () => _accessibilityOverlay__WEBPACK_IMPORTED_MODULE_1__.AccessibilityOverlay,
						CHECK_STATE_MASK: () => _types__WEBPACK_IMPORTED_MODULE_2__.CHECK_STATE_MASK,
						CHECK_STATE_OFFSET: () => _types__WEBPACK_IMPORTED_MODULE_2__.CHECK_STATE_OFFSET,
						SemanticActionType: () => _types__WEBPACK_IMPORTED_MODULE_2__.SemanticActionType,
						SemanticCheckState: () => _types__WEBPACK_IMPORTED_MODULE_2__.SemanticCheckState,
						SemanticMode: () => _types__WEBPACK_IMPORTED_MODULE_2__.SemanticMode,
						SemanticRole: () => _types__WEBPACK_IMPORTED_MODULE_2__.SemanticRole,
						SemanticState: () => _types__WEBPACK_IMPORTED_MODULE_2__.SemanticState,
						SemanticTrait: () => _types__WEBPACK_IMPORTED_MODULE_2__.SemanticTrait,
						SemanticTreeModel: () => _semanticTreeModel__WEBPACK_IMPORTED_MODULE_0__.SemanticTreeModel,
						checkStateOf: () => _types__WEBPACK_IMPORTED_MODULE_2__.checkStateOf,
						hasState: () => _types__WEBPACK_IMPORTED_MODULE_2__.hasState,
						hasTrait: () => _types__WEBPACK_IMPORTED_MODULE_2__.hasTrait,
						roleName: () => _types__WEBPACK_IMPORTED_MODULE_2__.roleName,
						stateNames: () => _types__WEBPACK_IMPORTED_MODULE_2__.stateNames,
						traitNames: () => _types__WEBPACK_IMPORTED_MODULE_2__.traitNames
					});
					var _semanticTreeModel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7);
					var _accessibilityOverlay__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9);
					var _types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8);
				}),
				((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					__webpack_require__.r(__webpack_exports__);
					__webpack_require__.d(__webpack_exports__, { SemanticTreeModel: () => SemanticTreeModel });
					var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8);
					...
					*/
					var SemanticTreeModel = function() {
						...
						*/
						SemanticTreeModel.prototype.applyDiff = function(diff) {
							...
							for (var _f = 0, _g = diff.moved; _f < _g.length; _f++) {
								...
								this.detach(n.id);
								this.attach(n.id, n.parentId, n.siblingIndex);
								if (parentChanged || this.siblingIndexOf(n.id) !== oldIndex) markSemantic();
							}
							...
							if (this._debug) this.logDiff(diff, semanticChanged, geometryChanged);
						};
						...
						SemanticTreeModel.prototype.logDiff = function(diff, semanticChanged, geometryChanged) {
							var lines = ["[rive:semantics] semantic v".concat(this._semanticVersion) + (geometryChanged ? " geometry v".concat(this._geometryVersion) : "") + (semanticChanged ? "" : " (geometry-only)")];
				...
				((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					__webpack_require__.r(__webpack_exports__);
					__webpack_require__.d(__webpack_exports__, {
						CHECK_STATE_MASK: () => CHECK_STATE_MASK,
						CHECK_STATE_OFFSET: () => CHECK_STATE_OFFSET,
						SemanticActionType: () => SemanticActionType,
						SemanticCheckState: () => SemanticCheckState,
						SemanticMode: () => SemanticMode,
						SemanticRole: () => SemanticRole,
						SemanticState: () => SemanticState,
						SemanticTrait: () => SemanticTrait,
						checkStateOf: () => checkStateOf,
						hasState: () => hasState,
						hasTrait: () => hasTrait,
						roleName: () => roleName,
					...
					*/
					...
					function stateNames(flags) {
						...
						for (var _i = 0, _stateEntries_1 = _stateEntries; _i < _stateEntries_1.length; _i++) {
							var _a = _stateEntries_1[_i], name_2 = _a[0];
							if (flags & _a[1]) active.push(name_2);
						}
					...
					function traitNames(flags) {
						...
						for (var _i = 0, _traitEntries_1 = _traitEntries; _i < _traitEntries_1.length; _i++) {
							var _a = _traitEntries_1[_i], name_3 = _a[0];
							if (flags & _a[1]) active.push(name_3);
						}
						return active.join(", ") || "none";
					}
				}),
				((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					__webpack_require__.r(__webpack_exports__);
					__webpack_require__.d(__webpack_exports__, { AccessibilityOverlay: () => AccessibilityOverlay });
					var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8);
					/**
					...
					*/
					var AccessibilityOverlay = function() {
						...
						*/
						AccessibilityOverlay.prototype.observePosition = function() {
							...
							(_a = this.positionObserver) === null || _a === void 0 || _a.disconnect();
							this.positionObserver = null;
						...
						AccessibilityOverlay.prototype.syncContainerGeometry = function() {
							...
							if (rect.width === this.lastCanvasPositioning.width && rect.height === this.lastCanvasPositioning.height && top === this.lastCanvasPositioning.offsetTop && left === this.lastCanvasPositioning.offsetLeft) return;
						...
						*/
						AccessibilityOverlay.prototype.update = function(tree, forwardMat, dpr, artboardBounds, change) {
							...
							if (!overlayChange && forwardMat) overlayChange = {
						...
						AccessibilityOverlay.prototype.performUpdate = function(tree, forwardMat, dpr, artboardBounds, change) {
							...
							if (semanticChanged) {
								...
								this.rebuildChildren(rootEl, tree.roots, tree, 0, 0, activeIds_1, reapplyAllAttributes);
								var staleIds_2 = [];
							...
							} else if (nodeGeometryChanged) this.updateGeometryForChangedNodes(tree);
						...
						AccessibilityOverlay.prototype.destroy = function() {
							...
							(_a = this.canvasResizeObserver) === null || _a === void 0 || _a.disconnect();
							(_b = this.parentResizeObserver) === null || _b === void 0 || _b.disconnect();
							(_c = this.positionObserver) === null || _c === void 0 || _c.disconnect();
						...
						*/
						AccessibilityOverlay.prototype.rebuildChildren = function(parentEl, childIds, tree, parentArtboardLeft, parentArtboardTop, activeIds, applyAllAttributes) {
							for (var i = 0; i < childIds.length; i++) {
								...
								if (isNew || applyAllAttributes || tree.semanticChangedIds.has(nodeId)) this.applyAttributes(el, nodeData);
								this.applyPosition(el, nodeData, parentArtboardLeft, parentArtboardTop);
								var currentChild = parentEl.children[i];
								if (currentChild !== el) if (currentChild) parentEl.insertBefore(el, currentChild);
								...
								if ((0, _types__WEBPACK_IMPORTED_MODULE_0__.hasTrait)(nodeData.traitFlags, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticTrait.Focusable) && (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(nodeData.stateFlags, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Focused)) {
									...
									if (active !== el && !trappedByModal && this.canMoveFocus()) el.focus();
								}
								if (nodeData.children.length > 0) this.rebuildChildren(el, nodeData.children, tree, nodeData.minX, nodeData.minY, activeIds, applyAllAttributes);
						...
						*/
						AccessibilityOverlay.prototype.canMoveFocus = function() {
							var active = document.activeElement;
							return active === this.canvas || this.container.contains(active) || this.allowFocusInterrupt;
						};
						/**
						...
						*/
						AccessibilityOverlay.prototype.routeDefaultFocusTarget = function(node, tree) {
							...
							for (var _i = 0, _b = node.children; _i < _b.length; _i++) {
								...
								if (childEl) return (_a = childEl.querySelector(":scope > span")) !== null && _a !== void 0 ? _a : childEl;
							}
							return null;
						};
						...
						*/
						AccessibilityOverlay.prototype.attachRovingNav = function(el, opts) {
							...
							el.addEventListener("keydown", function(e) {
								...
								if (next && next !== el) {
									...
									if (nextId !== null) _this.fireAction(nextId, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticActionType.tap);
								}
							});
						};
						AccessibilityOverlay.prototype.attachActionHandlers = function(el, node) {
							...
							if (role === _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.slider) el.addEventListener("keydown", function(e) {
							...
							if (role === _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.tab) this.attachRovingNav(el, {
								includeHomeEnd: true,
								members: function() {
							...
							if (role === _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.radioButton) this.attachRovingNav(el, {
							...
							if ((0, _types__WEBPACK_IMPORTED_MODULE_0__.hasTrait)(node.traitFlags, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticTrait.Focusable)) el.addEventListener("focus", function() {
						...
						AccessibilityOverlay.prototype.applyAttributes = function(el, node) {
							...
							if (ariaRole) setAttr(el, "role", ariaRole);
							else removeAttr(el, "role");
							if (role === _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.link) setAttr(el, "role", "link");
							if (isInteractiveRole(role) || (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasTrait)(traits, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticTrait.Focusable) || role === _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.listItem) setAttr(el, "tabindex", "-1");
							else removeAttr(el, "tabindex");
							if (node.label) setAttr(el, "aria-label", node.label);
							else removeAttr(el, "aria-label");
							if (role === _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.slider) {
								if (node.value) {
									var numericValue = parseFloat(node.value);
									if (Number.isFinite(numericValue)) setAttr(el, "aria-valuenow", String(numericValue));
									else removeAttr(el, "aria-valuenow");
							...
							if (role === _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.text) {
								...
								} else removeAttr(el, "aria-level");
							}
							if ((0, _types__WEBPACK_IMPORTED_MODULE_0__.hasTrait)(traits, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticTrait.Expandable) && ARIA_EXPANDED_ROLES.has(role)) setBoolAttr(el, "aria-expanded", (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(flags, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Expanded));
							else removeAttr(el, "aria-expanded");
							if (role === _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.tab) setBoolAttr(el, "aria-selected", (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(flags, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Selected));
							else if ((0, _types__WEBPACK_IMPORTED_MODULE_0__.hasTrait)(traits, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticTrait.Selectable) && ARIA_SELECTED_ROLES.has(role)) setBoolAttr(el, "aria-selected", (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(flags, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Selected));
							else removeAttr(el, "aria-selected");
							if ((0, _types__WEBPACK_IMPORTED_MODULE_0__.hasTrait)(traits, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticTrait.Checkable) && ARIA_CHECKED_ROLES.has(role)) {
								...
								if (checkState === _types__WEBPACK_IMPORTED_MODULE_0__.SemanticCheckState.Mixed && ARIA_MIXED_ROLES.has(role)) setAttr(el, "aria-checked", "mixed");
								else setBoolAttr(el, "aria-checked", checkState === _types__WEBPACK_IMPORTED_MODULE_0__.SemanticCheckState.Checked);
							} else removeAttr(el, "aria-checked");
							if ((0, _types__WEBPACK_IMPORTED_MODULE_0__.hasTrait)(traits, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticTrait.Toggleable)) {
								if (ARIA_PRESSED_ROLES.has(role)) setBoolAttr(el, "aria-pressed", (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(flags, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Toggled));
								else removeAttr(el, "aria-pressed");
								if (role === _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.switchControl) setBoolAttr(el, "aria-checked", (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(flags, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Toggled));
							} else removeAttr(el, "aria-pressed");
							if ((0, _types__WEBPACK_IMPORTED_MODULE_0__.hasTrait)(traits, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticTrait.Requirable) && ARIA_REQUIRED_ROLES.has(role)) setBoolAttr(el, "aria-required", (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(flags, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Required));
							else removeAttr(el, "aria-required");
							if ((0, _types__WEBPACK_IMPORTED_MODULE_0__.hasTrait)(traits, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticTrait.Enablable)) setBoolAttr(el, "aria-disabled", (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(flags, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Disabled));
							...
							if ((0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(flags, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Hidden) || (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(flags, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Obscured) || isDecorativeImage) setAttr(el, "aria-hidden", "true");
							else removeAttr(el, "aria-hidden");
							if ((0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(flags, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.LiveRegion)) setAttr(el, "aria-live", "polite");
							else removeAttr(el, "aria-live");
							...
							} else removeAttr(el, "aria-multiline");
							if (isModalDialogRole(role, flags)) setAttr(el, "aria-modal", "true");
							else removeAttr(el, "aria-modal");
						};
						/**
						...
						*/
						AccessibilityOverlay.prototype.applyPosition = function(el, node, parentArtboardLeft, parentArtboardTop) {
							...
							if (node.role === _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.text) this.pendingTextGeometry.push(el);
						};
						/**
					...
					*/
					var ARIA_SELECTED_ROLES = new Set([_types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.tab]);
					...
					*/
					var ARIA_MIXED_ROLES = new Set([_types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.checkbox]);
					/**
					...
					*/
					var ARIA_PRESSED_ROLES = new Set([_types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.button]);
					...
					*/
					...
					function isClickableRole(role) {
						switch (role) {
							...
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.radioButton: return true;
					...
					function isInteractiveRole(role) {
						switch (role) {
							...
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.textField: return true;
							default: return false;
						}
					}
					/**
					...
					*/
					function tagForRole(role) {
						switch (role) {
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.link: return "a";
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.text: return "div";
							default: return "div";
						}
					}
					/**
					...
					*/
					function ariaRoleForSemantic(role) {
						switch (role) {
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.none: return "group";
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.button: return "button";
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.link: return null;
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.checkbox: return "checkbox";
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.switchControl: return "switch";
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.slider: return "slider";
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.textField: return "textbox";
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.image: return "img";
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.group: return "group";
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.list: return "list";
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.listItem: return "listitem";
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.tab: return "tab";
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.tabList: return "tablist";
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.dialog: return "dialog";
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.alertDialog: return "alertdialog";
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.radioGroup: return "radiogroup";
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.radioButton: return "radio";
							case _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.text: return null;
							default: return null;
						}
					}
				}),
				((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					__webpack_require__.r(__webpack_exports__);
					__webpack_require__.d(__webpack_exports__, {
						AudioAssetWrapper: () => _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.AudioAssetWrapper,
						AudioWrapper: () => _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.AudioWrapper,
						BLANK_URL: () => _sanitizeUrl__WEBPACK_IMPORTED_MODULE_2__.BLANK_URL,
						CustomFileAssetLoaderWrapper: () => _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.CustomFileAssetLoaderWrapper,
						FileAssetWrapper: () => _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.FileAssetWrapper,
						FileFinalizer: () => _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.FileFinalizer,
						FocusSessionState: () => _registerKeyboardInteractions__WEBPACK_IMPORTED_MODULE_1__.FocusSessionState,
						FontAssetWrapper: () => _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.FontAssetWrapper,
						FontWrapper: () => _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.FontWrapper,
						ImageAssetWrapper: () => _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.ImageAssetWrapper,
						ImageWrapper: () => _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.ImageWrapper,
						KeyboardInteractions: () => _registerKeyboardInteractions__WEBPACK_IMPORTED_MODULE_1__.KeyboardInteractions,
						RiveFont: () => _riveFont__WEBPACK_IMPORTED_MODULE_4__.RiveFont,
						createFinalization: () => _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.createFinalization,
						finalizationRegistry: () => _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.finalizationRegistry,
						registerTouchInteractions: () => _registerTouchInteractions__WEBPACK_IMPORTED_MODULE_0__.registerTouchInteractions,
						sanitizeUrl: () => _sanitizeUrl__WEBPACK_IMPORTED_MODULE_2__.sanitizeUrl
					});
					var _registerTouchInteractions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
					var _registerKeyboardInteractions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12);
					var _sanitizeUrl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(13);
					var _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(14);
					var _riveFont__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(15);
				}),
				((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					__webpack_require__.r(__webpack_exports__);
					__webpack_require__.d(__webpack_exports__, { registerTouchInteractions: () => registerTouchInteractions });
					var _this = void 0;
					/**
					...
					*/
					var getTouchCoordinates = function(changedTouches, enableMultiTouch, primaryTouchId) {
						var _a;
						var coordinates = [];
						if (enableMultiTouch) for (var i = 0; i < changedTouches.length; i++) {
							...
							if (primaryTouch) coordinates.push({
					...
					*/
					var getClientCoordinates = function(event, isTouchScrollEnabled, enableMultiTouch, primaryTouchId) {
						...
						if ((_a = touchEvent.changedTouches) === null || _a === void 0 ? void 0 : _a.length) {
							if (!isTouchScrollEnabled && ["touchstart", "touchmove"].includes(event.type)) event.preventDefault();
						...
						*/
						...
						var processEventCallback = function(event) {
							...
							if (!enableMultiTouch && event.type === "touchstart" && _primaryTouchId === null) {
								...
								if (firstTouch) _primaryTouchId = firstTouch.identifier;
							}
							...
							switch (event.type) {
								case "mouseout":
									var _loop_1 = function(stateMachine) {
										if (dispatchPointerExit) coordinateSets.forEach(function(coordinateSet) {
											stateMachine.pointerExit(coordinateSet.transformedX, coordinateSet.transformedY, coordinateSet.identifier);
										});
										else coordinateSets.forEach(function(coordinateSet) {
						...
						canvas.addEventListener("touchmove", callback, { passive: isTouchScrollEnabled });
						canvas.addEventListener("touchstart", callback, { passive: isTouchScrollEnabled });
					...
					var KeyboardInteractions = function() {
						function KeyboardInteractions(_a) {
							...
							*/
							this.onCanvasFocus = function(event) {
								...
								if (_this.cameFromBeforeCanvas(event.relatedTarget) ? _this.mainSm.focusNext() : _this.mainSm.focusPrevious()) _this.focusSessionState = FocusSessionState.RiveFocused;
							};
							/**
							...
							*/
							...
							this.onKeyDown = function(event) {
								...
								if (event.code === "Tab" && _this.hasFocusNodes) {
									if (!event.shiftKey ? _this.mainSm.focusNext() : _this.mainSm.focusPrevious()) {
						...
						*/
						...
						KeyboardInteractions.prototype.syncOverlayListener = function() {
							...
							(_c = this.currentOverlayElement) === null || _c === void 0 || _c.removeEventListener("focusin", this.onOverlayFocusIn);
							(_d = this.currentOverlayElement) === null || _d === void 0 || _d.removeEventListener("keydown", this.onKeyDown, true);
							this.currentOverlayElement = nextOverlayElement;
							(_e = this.currentOverlayElement) === null || _e === void 0 || _e.addEventListener("focusin", this.onOverlayFocusIn);
							(_f = this.currentOverlayElement) === null || _f === void 0 || _f.addEventListener("keydown", this.onKeyDown, true);
						};
						/**
						...
						*/
						...
						KeyboardInteractions.prototype.cleanup = function() {
							...
							(_a = this.currentOverlayElement) === null || _a === void 0 || _a.removeEventListener("focusin", this.onOverlayFocusIn);
							(_b = this.currentOverlayElement) === null || _b === void 0 || _b.removeEventListener("keydown", this.onKeyDown, true);
						};
				...
				((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					__webpack_require__.r(__webpack_exports__);
					__webpack_require__.d(__webpack_exports__, {
						AudioAssetWrapper: () => AudioAssetWrapper,
						AudioWrapper: () => AudioWrapper,
						CustomFileAssetLoaderWrapper: () => CustomFileAssetLoaderWrapper,
						FileAssetWrapper: () => FileAssetWrapper,
						FileFinalizer: () => FileFinalizer,
						FontAssetWrapper: () => FontAssetWrapper,
						FontWrapper: () => FontWrapper,
						ImageAssetWrapper: () => ImageAssetWrapper,
					...
					var FileFinalizer = function() {
						...
						FileFinalizer.prototype.unref = function() {
							if (this._file) this._file.unref();
							if (this._session) {
					...
					var ImageWrapper = function(_super) {
						...
						ImageWrapper.prototype.unref = function() {
							if (this.selfUnref) this._nativeImage.unref();
						};
						return ImageWrapper;
					}(AssetWrapper);
					var AudioWrapper = function(_super) {
						...
						AudioWrapper.prototype.unref = function() {
							if (this.selfUnref) this._nativeAudio.unref();
						};
						return AudioWrapper;
					}(AssetWrapper);
					var FontWrapper = function(_super) {
						...
						FontWrapper.prototype.unref = function() {
							if (this.selfUnref) this._nativeFont.unref();
						};
						return FontWrapper;
					}(AssetWrapper);
					var CustomFileAssetLoaderWrapper = function() {
						function CustomFileAssetLoaderWrapper(runtime, loaderCallback, session) {
							...
							this._session = session;
							this.assetLoader = new runtime.CustomFileAssetLoader({ loadContents: this.loadContents.bind(this) });
						}
						CustomFileAssetLoaderWrapper.prototype.loadContents = function(asset, bytes) {
							var assetWrapper;
							if (asset.isImage) assetWrapper = new ImageAssetWrapper(asset, this._session);
							else if (asset.isAudio) assetWrapper = new AudioAssetWrapper(asset, this._session);
							else if (asset.isFont) assetWrapper = new FontAssetWrapper(asset, this._session);
							else return false;
					...
					*/
					...
					var finalizationRegistry = new (typeof FinalizationRegistry !== "undefined" ? FinalizationRegistry : FakeFinalizationRegistry)(function(ob) {
						ob === null || ob === void 0 || ob.unref();
					});
				...
				((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					__webpack_require__.r(__webpack_exports__);
					__webpack_require__.d(__webpack_exports__, { RiveFont: () => RiveFont });
					var _runtimeLoader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
						...
						*/
						...
						RiveFont._wireFallbackProc = function() {
							_runtimeLoader__WEBPACK_IMPORTED_MODULE_0__.RuntimeLoader.getInstance(function(rive) {
								...
								if (cb) rive.setFallbackFontCallback((function(missingGlyph, fallbackFontIndex, weight) {
									var fontsReturned = cb(missingGlyph, weight);
									if (fontsReturned) {
										if (Array.isArray(fontsReturned)) return RiveFont._getFallbackPtr(fontsReturned, fallbackFontIndex);
										return fallbackFontIndex === 0 ? RiveFont._fontToPtr(fontsReturned) : null;
									}
									return null;
								}));
								else rive.setFallbackFontCallback(null);
							});
						};
			...
			function __webpack_require__(moduleId) {
				...
				__webpack_modules__[moduleId](module$2, module$2.exports, __webpack_require__);
			...
			(() => {
				...
				__webpack_require__.d(__webpack_exports__, {
					...
					RiveFile: () => RiveFile,
					RiveFont: () => _utils__WEBPACK_IMPORTED_MODULE_3__.RiveFont,
					RuntimeLoader: () => _runtimeLoader__WEBPACK_IMPORTED_MODULE_1__.RuntimeLoader,
					SemanticMode: () => _semantics__WEBPACK_IMPORTED_MODULE_2__.SemanticMode,
				...
				var BindableArtboard = function(_super) {
					...
					BindableArtboard.prototype.destroy = function() {
						...
						if (this.selfUnref) {
							...
							(_a = this.nativeViewModel) === null || _a === void 0 || _a.unref();
						}
					};
					...
					Animator.prototype.add = function(animatables, playing, fireEvent, semanticsActive) {
						...
						if (animatables.length === 0) {
							...
							for (var i = 0; i < animatables.length; i++) {
								...
								if (aIndex >= 0 || mIndex >= 0) if (aIndex >= 0) this.animations[aIndex].playing = playing;
								else this.stateMachines[mIndex].playing = playing;
								else {
									...
									if (anim) {
										...
										if (sm) {
											...
											if (semanticsActive) newStateMachine.enableSemantics();
						...
						for (var i = 0; i < animatables.length; i++) {
							...
							if (aIndex >= 0) this.animations[aIndex].playing = playing;
								...
								if (anim) {
									...
									newAnimation.apply(1);
									this.animations.push(newAnimation);
								} else if (isFallingBackFromStateMachines) throw new RiveError("State Machine with name ".concat(animatables[i], " not found"));
								else console.error("Animation with name ".concat(animatables[i], " not found."));
							}
						}
					};
					/**
					...
					*/
					Animator.prototype.advanceIfPaused = function() {
						this.stateMachines.forEach(function(sm) {
							if (!sm.playing) sm.advanceAndApply(0);
						});
					};
					/**
					...
					Animator.prototype.atLeastOne = function(playing, fireEvent, semanticsActive) {
						...
						if (this.animations.length === 0 && this.stateMachines.length === 0) {
							if (this.artboard.animationCount() > 0) {
								if (this.artboard.stateMachineCount() > 0) warnOnce("No `stateMachine` was specified, so the artboard's first linear animation is playing by default. In the next major version, the artboard's state machine will be played by default instead when one exists. Pass the `stateMachine` parameter to adopt that behavior now.");
								this.add([instancedName = this.artboard.animationByIndex(0).name], playing, fireEvent);
							} else if (this.artboard.stateMachineCount() > 0) this.add([instancedName = this.artboard.stateMachineByIndex(0).name], playing, fireEvent, semanticsActive);
						}
				...
				*/
				...
				var riveEventsDeprecationWarning = "Rive Events are deprecated and will be removed in a future major version: please use data binding instead. See https://rive.app/docs/runtimes/web/rive-events for how to migrate.";
				...
				var stateChangeEventsDeprecationWarning = "State change events are deprecated and will be removed in a future major version: use data binding (view model property observers) or state machine actions to react to changes from your graphic instead. See https://rive.app/docs/editor/state-machine/states#actions for how to migrate.";
				...
				*/
				var warnIfNamesArray = function(names, methodName) {
					if (Array.isArray(names)) warnOnce("Passing an array of names to `".concat(methodName, "()` is deprecated: in the next major version this parameter will be a single string, and playing multiple animations or state machines at once will not be supported."));
				};
				/**
				...
				*/
				var warnDeprecatedAnimationNames = function(methodName) {
					warnOnce("Passing linear animation names to `".concat(methodName, "()` is deprecated and will be removed in a future major version: ") + "Pass a single state machine name to control playback instead.");
				};
				/**
				...
				*/
				...
				var audioManager = new (function(_super) {
					...
					*/
					...
					AudioManager.prototype.listenForUserAction = function() {
						...
						document.addEventListener("pointerdown", _clickListener, { once: true });
					};
					/**
				...
				*/
				var resolveStartingPlayback = function(_a) {
					...
					if (animations !== void 0) warnOnce("The `animations` parameter is deprecated and will be removed in a future major version: please use the `stateMachine` parameter to play a state machine instead.");
					if (stateMachines !== void 0) warnOnce("The `stateMachines` parameter is deprecated: please use `stateMachine` with a single state machine name instead.");
				...
				var RiveFile = function() {
					...
					RiveFile.prototype.releaseFile = function() {
						var _a, _b;
						(_a = this.fileFinalizer) === null || _a === void 0 || _a.release();
						(_b = this.file) === null || _b === void 0 || _b.unref();
						this.fileFinalizer = null;
						this.file = null;
					};
					RiveFile.prototype.releaseSession = function() {
						var _a;
						(_a = this.session) === null || _a === void 0 || _a.delete();
						this.session = null;
					};
						...
						return __awaiter(this, void 0, void 0, function() {
							...
							return __generator(this, function(_c) {
								switch (_c.label) {
									...
									case 3:
										error_1 = _c.sent();
										if (error_1 instanceof Error) throw error_1;
										throw new RiveError(RiveFile.fileLoadErrorMessage);
									case 4:
										if (this.destroyed) return [2];
										if (this.deferred && this.session === null) this.session = RiveFile.makeDeferredSession(this.runtime);
										if (this.assetLoader) {
					...
					RiveFile.prototype.loadRiveFileBytes = function() {
						return __awaiter(this, void 0, void 0, function() {
							...
							return __generator(this, function(_a) {
								...
								if (this.enablePerfMarks && this.src) bufferPromise.then(function() {
					...
					RiveFile.prototype.loadRuntime = function() {
						return __awaiter(this, void 0, void 0, function() {
							...
							return __generator(this, function(_a) {
								...
								if (this.enablePerfMarks) runtimePromise.then(function() {
					...
					*/
					RiveFile.prototype.warnBoundElsewhereOnce = function() {
						if (this.boundElsewhereWarned) return;
					...
					*/
					...
					RiveFile.prototype.destroyIfUnused = function() {
						if (this.referenceCount <= 0) this.cleanup();
					};
					...
					*/
					RiveFile.prototype.getArtboard = function(name) {
						...
						if (nativeArtboard != null) return new Artboard(nativeArtboard, this);
					};
				...
				var Rive = function() {
					function Rive(params) {
						...
						*/
						...
						this._focusOptions = { allowFocusInterrupt: false };
						...
						*/
						...
						if (params.automaticallyHandleEvents) warnOnce("The `automaticallyHandleEvents` parameter is deprecated. " + riveEventsDeprecationWarning);
					...
					*/
					...
					Rive.prototype.activateSemantics = function() {
						if (this._semanticsActive || this.semanticsMode === _semantics__WEBPACK_IMPORTED_MODULE_2__.SemanticMode.Disabled) return;
						this._semanticsActive = true;
						this.syncSemanticsOnStateMachines();
					};
					Rive.prototype.syncSemanticsOnStateMachines = function() {
						if (!this._semanticsActive || !this.animator) return;
						for (var _i = 0, _a = this.animator.stateMachines; _i < _a.length; _i++) _a[_i].enableSemantics();
					};
					/**
					...
					*/
					...
					Rive.prototype.init = function(_a) {
						...
						if (!src && !buffer && !riveFile) throw new RiveError(Rive.missingErrorMessage);
						if (this.artboard) {
							(_c = (_b = this.renderer) === null || _b === void 0 ? void 0 : _b.bindContext) === null || _c === void 0 || _c.call(_b);
							(_d = this.animator) === null || _d === void 0 || _d.stop();
							this.artboard.delete();
							this.artboard = null;
						}
						if (this.renderer) (_f = (_e = this.renderer).detachSession) === null || _f === void 0 || _f.call(_e);
						this.releaseCurrentRiveFile(false);
						this.src = src;
						this.buffer = buffer;
						...
						_runtimeLoader__WEBPACK_IMPORTED_MODULE_1__.RuntimeLoader.awaitInstance().then(function(runtime) {
							...
							try {
								...
								if (!_this.renderer) throw new Error("Renderer is null, cannot render Rive on the canvas.");
							} catch (e) {
								console.error(e);
							...
							_this.initData(artboard, startingAnimationNames, startingStateMachineNames, autoplay, autoBind).then(function(hasInitialized) {
								if (hasInitialized) return _this.setupRiveListeners();
							}).catch(function(e) {
								console.error(e);
							});
						}).catch(function(e) {
					...
					*/
					Rive.prototype.ensureKeyboardInteractions = function() {
						var _this = this;
						if (this._keyboardInteractions || this.shouldDisableRiveListeners || typeof window === "undefined" || !(this.canvas instanceof HTMLCanvasElement)) return;
						var smWithFocusNodes = this.animator.stateMachines.find(function(sm) {
							return sm.playing && sm.hasFocusNodes;
						});
						if (!smWithFocusNodes) return;
						var currentCanvasTabIndex = this.canvas.tabIndex;
						if (currentCanvasTabIndex === -1 || isNaN(currentCanvasTabIndex)) this.canvas.tabIndex = this._tabIndex !== null ? this._tabIndex : 0;
							...
							return __generator(this, function(_c) {
								switch (_c.label) {
									...
									case 3:
										_c.sent();
										if (this.destroyed) {
											if (this.ownsRiveFile) (_a = this.riveFile) === null || _a === void 0 || _a.destroyIfUnused();
											return [2, false];
										}
										_c.label = 4;
									case 4:
										...
										if (this.semanticsMode === _semantics__WEBPACK_IMPORTED_MODULE_2__.SemanticMode.Enabled) this.activateSemantics();
										else if (this._semanticsActive) this.syncSemanticsOnStateMachines();
										try {
											this.loaded = true;
											this.eventManager.fire({
												type: EventType.Load,
					...
					*/
							...
							return __generator(this, function(_b) {
								switch (_b.label) {
									case 0:
										...
										if (session === null) {
											if (this.deferredRenderer && !file.deferredRequested) console.warn("Rive: `enableGPUCanvas: true` was ignored because this RiveFile was imported without it. The mode is fixed at import: construct the RiveFile with `enableGPUCanvas: true` to opt in.");
											return [2];
										}
										if (!this.deferredRenderer) console.warn("Rive: this RiveFile was imported with `enableGPUCanvas: true`, so this instance renders deferred even though `enableGPUCanvas` is false on the instance. An immediate renderer would drop the file's deferred resources and draw nothing.");
									...
									case 1:
										...
										if (ownsFile) file.destroyIfUnused();
										return [2];
									case 2:
									...
									case 3:
										...
										(_a = renderer.detachSession) === null || _a === void 0 || _a.call(renderer);
										return [4, file.reimport(false)];
									case 4:
										fallback = _b.sent();
										copy.destroyIfUnused();
					...
					Rive.prototype.initArtboard = function(artboardName, animationNames, stateMachineNames, autoplay, autoBind) {
						...
						if (!rootArtboard) throw new RiveError("Invalid artboard name or no default artboard");
						...
						} else instanceNames = [this.animator.atLeastOne(autoplay, false, this._semanticsActive)];
						...
						if (autoBind) {
							...
							for (var _i = 0, _a = this.file.globalViewModelNames(); _i < _a.length; _i++) {
								...
								if (globalViewModel !== null) {
									...
									if (instance !== null) this.setGlobalViewModelInstance(name_1, instance);
								}
							}
							this.bind();
						}
					...
					*/
					Rive.prototype.pollFocusState = function() {
						...
						if (this.canvas instanceof HTMLCanvasElement) {
							if (activeSm.focusState().hasFocus) {
								...
								if (!this._prevHasFocus) {
									...
									if (!(document.activeElement === this.canvas || ((_b = scope === null || scope === void 0 ? void 0 : scope.contains(document.activeElement)) !== null && _b !== void 0 ? _b : false)) && this._focusOptions.allowFocusInterrupt) this.canvas.focus();
									this._prevHasFocus = true;
								}
								return;
							}
							this._prevHasFocus = false;
							if (this._keyboardInteractions.focusSessionState === _utils__WEBPACK_IMPORTED_MODULE_3__.FocusSessionState.RiveFocused) this._keyboardInteractions.setFocusSessionState(_utils__WEBPACK_IMPORTED_MODULE_3__.FocusSessionState.NotFocused);
						}
					};
					/**
					...
					Rive.prototype.advanceAndReportChanges = function(elapsedTime) {
						...
						for (var _c = 0, activeStateMachines_1 = activeStateMachines; _c < activeStateMachines_1.length; _c++) {
							...
							if (numEventsReported) for (var i = 0; i < numEventsReported; i++) {
								...
								if (event_1) if (event_1.type === RiveEventType.OpenUrl) {
									this.eventManager.fire({
							...
							if (this._semanticsActive) {
								...
								if (diff) {
									if (!this._semanticTree) this._semanticTree = new _semantics__WEBPACK_IMPORTED_MODULE_2__.SemanticTreeModel();
						...
						if (this._semanticsActive && this._semanticTree && activeStateMachines.length > 0 && this.canvas instanceof HTMLCanvasElement) {
							...
							if (overlayChange || this._overlayTransformDirty) {
								...
								forwardMat === null || forwardMat === void 0 || forwardMat.delete();
							}
						}
						...
						this.pollFocusState();
						(_b = this._viewModelInstance) === null || _b === void 0 || _b.handleCallbacks();
						this._globalViewModelInstances.forEach(function(instance) {
							if (instance) instance.handleCallbacks();
						});
					};
					/**
					...
					*/
					Rive.prototype.draw = function(time, onSecond) {
						...
						if (this.animator.isPlaying) this.scheduleRendering();
						else if (this.animator.isPaused) this.lastRenderTime = 0;
						else if (this.animator.isStopped) this.lastRenderTime = 0;
					};
					/**
					* Align the renderer
					*/
					...
					*/
					Rive.prototype.cleanup = function() {
						...
						this.destroyed = true;
						this.stopRendering();
						(_b = (_a = this.renderer) === null || _a === void 0 ? void 0 : _a.bindContext) === null || _b === void 0 || _b.call(_a);
						this.cleanupInstances();
						if (this._observed !== null) observers.remove(this._observed);
						this.removeRiveListeners();
						if (this.renderer) (_d = (_c = this.renderer).detachSession) === null || _d === void 0 || _d.call(_c);
						this.releaseCurrentRiveFile(true);
						this.riveFile = null;
						...
						(_e = this._viewModelInstance) === null || _e === void 0 || _e.cleanup();
						this._viewModelInstance = null;
						this._globalViewModelInstances.forEach(function(instance) {
					...
					*/
					Rive.prototype.releaseCurrentRiveFile = function(isTeardown) {
						var _a, _b;
						if (this.file) {
							if (isTeardown || this.ownsRiveFile) (_a = this.riveFile) === null || _a === void 0 || _a.cleanup();
							this.file = null;
						} else if (this.ownsRiveFile) (_b = this.riveFile) === null || _b === void 0 || _b.destroyIfUnused();
					};
					/**
					...
					*/
					Rive.prototype.deleteRiveRenderer = function() {
						var _a, _b;
						if (this.renderer) {
							(_b = (_a = this.renderer).detachSession) === null || _b === void 0 || _b.call(_a);
					...
					*/
					Rive.prototype.cleanupInstances = function() {
						...
						(_a = this.animator) === null || _a === void 0 || _a.stop();
						if (this.artboard) {
							this.artboard.delete();
							this.artboard = null;
						}
					...
					*/
					Rive.prototype.scrub = function(animationNames, value) {
						var _this = this;
						warnOnce("`scrub()` is deprecated and will be removed in a future major version: use a state machine to control playback instead.");
						var names = mapToStringArray(animationNames);
						if (!this.readyForPlaying) {
							this.taskQueue.add({ action: function() {
					...
					*/
					Rive.prototype.stop = function(animationNames) {
						...
						if (this.animator) this.animator.stop(names);
						if (this.eventCleanup) this.eventCleanup();
						this.cleanupKeyboardInteractions();
						this.cleanupSemantics();
					};
					...
					*/
					Rive.prototype.reset = function(params) {
						...
						this.cleanupInstances();
						this.initArtboard(artBoardName, animationNames, stateMachineNames, autoplay, autoBind);
						if (this.readyForPlaying) this.taskQueue.process();
					};
					Rive.prototype.load = function(params) {
						if (!params.src && !params.buffer && !params.riveFile) throw new RiveError(Rive.missingErrorMessage);
						this.stop();
						this.init(params);
					};
					...
					*/
					Rive.prototype.on = function(type, callback) {
						if (type === EventType.RiveEvent) warnOnce(riveEventsDeprecationWarning);
						else if (type === EventType.StateChange) warnOnce(stateChangeEventsDeprecationWarning);
						else if (type === EventType.Loop) warnOnce(loopEventsDeprecationWarning);
						this.eventManager.add({
							type,
							callback
						});
					...
					*/
					...
					Rive.prototype.scheduleRendering = function() {
						if (this.loaded && this.artboard && !this.frameRequestId) if (this.runtime.requestAnimationFrame) this.frameRequestId = this.runtime.requestAnimationFrame(this._boundDraw);
					...
					Rive.prototype._onPageVisibilityChange = function() {
						...
						if (document.hidden) {
							if (this.frameRequestId !== null) {
								if ((_a = this.runtime) === null || _a === void 0 ? void 0 : _a.cancelAnimationFrame) this.runtime.cancelAnimationFrame(this.frameRequestId);
								else cancelAnimationFrame(this.frameRequestId);
								this.frameRequestId = null;
							}
							this.lastRenderTime = 0;
						} else if (((_b = this.animator) === null || _b === void 0 ? void 0 : _b.isPlaying) && !this._explicitlyStoppedRendering) this.scheduleRendering();
					};
					/**
					...
					*/
					...
					Object.defineProperty(Rive.prototype, "devicePixelRatioUsed", {
						...
						set: function(value) {
							if (value !== this._devicePixelRatioUsed) this._overlayTransformDirty = true;
					...
					*/
					Rive.prototype.setViewModelInstance = function(viewModelInstance) {
						...
						if (!this.artboard || this.destroyed || !viewModelInstance || !runtimeInstance) return;
						viewModelInstance.internalIncrementReferenceCount();
						(_a = this._viewModelInstance) === null || _a === void 0 || _a.cleanup();
						this._viewModelInstance = viewModelInstance;
						if (this.animator.stateMachines.length > 0) this.animator.stateMachines.forEach(function(stateMachine) {
							return stateMachine.instance.setViewModelInstance(runtimeInstance);
						});
						else this.artboard.setViewModelInstance(runtimeInstance);
					};
					/**
					...
					*/
					Rive.prototype.bind = function() {
						if (!this.artboard || this.destroyed) return;
						if (this.animator.stateMachines.length > 0) this.animator.stateMachines.forEach(function(stateMachine) {
							return stateMachine.instance.bind();
						});
						else this.artboard.bind();
					};
					...
					*/
					Rive.prototype.setGlobalViewModelInstance = function(name, viewModelInstance) {
						var _a;
						var runtimeInstance = viewModelInstance === null || viewModelInstance === void 0 ? void 0 : viewModelInstance.runtimeInstance;
						if (!this.artboard || this.destroyed || !runtimeInstance) return false;
						var bound = false;
						if (this.animator.stateMachines.length > 0) this.animator.stateMachines.forEach(function(stateMachine) {
							if (stateMachine.instance.setGlobalViewModelInstance(name, runtimeInstance)) bound = true;
						});
						else bound = this.artboard.setGlobalViewModelInstance(name, runtimeInstance);
						if (bound) {
							viewModelInstance.internalIncrementReferenceCount();
							(_a = this._globalViewModelInstances.get(name)) === null || _a === void 0 || _a.cleanup();
					...
					*/
					...
					Rive.prototype.enums = function() {
						if (this._dataEnums === null) this._dataEnums = this.file.enums().map(function(dataEnum) {
					...
					*/
					Rive.prototype.clearFocus = function() {
						this.animator.stateMachines.filter(function(sm) {
							return sm.playing && sm.hasFocusNodes;
						}).forEach(function(sm) {
				...
				var ViewModelInstance = function() {
					function ViewModelInstance(runtimeInstance, parent) {
						...
						if (parent !== null) this._parents.push(parent);
					}
					...
					ViewModelInstance.prototype.addParent = function(parent) {
						if (!this._parents.includes(parent)) {
							...
							if (this._propertiesWithCallbacks.length > 0 || this._children.length > 0) parent.addToViewModelCallbacks(this);
						}
					};
					ViewModelInstance.prototype.removeParent = function(parent) {
						var index = this._parents.indexOf(parent);
						if (index !== -1) {
							this._parents[index].removeFromViewModelCallbacks(this);
					...
					ViewModelInstance.prototype.addToPropertyCallbacks = function(property) {
						...
						if (!this._propertiesWithCallbacks.includes(property)) {
							...
							if (this._propertiesWithCallbacks.length > 0) this._parents.forEach(function(parent) {
					...
					ViewModelInstance.prototype.removeFromPropertyCallbacks = function(property) {
						...
						if (this._propertiesWithCallbacks.includes(property)) {
							...
							if (this._children.length === 0 && this._propertiesWithCallbacks.length === 0) this._parents.forEach(function(parent) {
					...
					ViewModelInstance.prototype.viewModelFromPathSegments = function(pathSegments, index) {
						...
						if (viewModelInstance !== null) if (index == pathSegments.length - 1) return viewModelInstance;
						else return viewModelInstance.viewModelFromPathSegments(pathSegments, index++);
						return null;
					};
					ViewModelInstance.prototype.propertyFromPathSegments = function(pathSegments, index, type) {
						...
						if (index < pathSegments.length - 1) {
							var viewModelInstance = this.internalViewModelInstance(pathSegments[index]);
							if (viewModelInstance !== null) return viewModelInstance.propertyFromPathSegments(pathSegments, index + 1, type);
							else return null;
						}
						var instance = null;
						switch (type) {
							case PropertyType.Number:
								...
								if (instance !== null) return new ViewModelInstanceNumber(instance, this);
								break;
							case PropertyType.String:
								instance = (_d = (_c = this._runtimeInstance) === null || _c === void 0 ? void 0 : _c.string(pathSegments[index])) !== null && _d !== void 0 ? _d : null;
								if (instance !== null) return new ViewModelInstanceString(instance, this);
								break;
							case PropertyType.Boolean:
								instance = (_f = (_e = this._runtimeInstance) === null || _e === void 0 ? void 0 : _e.boolean(pathSegments[index])) !== null && _f !== void 0 ? _f : null;
								if (instance !== null) return new ViewModelInstanceBoolean(instance, this);
								break;
							case PropertyType.Color:
								instance = (_h = (_g = this._runtimeInstance) === null || _g === void 0 ? void 0 : _g.color(pathSegments[index])) !== null && _h !== void 0 ? _h : null;
								if (instance !== null) return new ViewModelInstanceColor(instance, this);
								break;
							case PropertyType.Trigger:
								instance = (_k = (_j = this._runtimeInstance) === null || _j === void 0 ? void 0 : _j.trigger(pathSegments[index])) !== null && _k !== void 0 ? _k : null;
								if (instance !== null) return new ViewModelInstanceTrigger(instance, this);
								break;
							case PropertyType.Enum:
								instance = (_m = (_l = this._runtimeInstance) === null || _l === void 0 ? void 0 : _l.enum(pathSegments[index])) !== null && _m !== void 0 ? _m : null;
								if (instance !== null) return new ViewModelInstanceEnum(instance, this);
								break;
							case PropertyType.List:
								instance = (_p = (_o = this._runtimeInstance) === null || _o === void 0 ? void 0 : _o.list(pathSegments[index])) !== null && _p !== void 0 ? _p : null;
								if (instance !== null) return new ViewModelInstanceList(instance, this);
								break;
							case PropertyType.Image:
								instance = (_r = (_q = this._runtimeInstance) === null || _q === void 0 ? void 0 : _q.image(pathSegments[index])) !== null && _r !== void 0 ? _r : null;
								if (instance !== null) return new ViewModelInstanceAssetImage(instance, this);
								break;
							case PropertyType.Font:
								instance = (_t = (_s = this._runtimeInstance) === null || _s === void 0 ? void 0 : _s.font(pathSegments[index])) !== null && _t !== void 0 ? _t : null;
								if (instance !== null) return new ViewModelInstanceAssetFont(instance, this);
								break;
							case PropertyType.Artboard:
								instance = (_v = (_u = this._runtimeInstance) === null || _u === void 0 ? void 0 : _u.artboard(pathSegments[index])) !== null && _v !== void 0 ? _v : null;
								if (instance !== null) return new ViewModelInstanceArtboard(instance, this);
								break;
						}
						return null;
					};
					ViewModelInstance.prototype.internalViewModelInstance = function(name) {
						var _a;
						if (this._viewModelInstances.has(name)) return this._viewModelInstances.get(name);
					...
					*/
					ViewModelInstance.prototype.number = function(path) {
						return this.propertyFromPath(path, PropertyType.Number);
					};
					/**
					...
					*/
					ViewModelInstance.prototype.string = function(path) {
						return this.propertyFromPath(path, PropertyType.String);
					};
					/**
					...
					*/
					ViewModelInstance.prototype.boolean = function(path) {
						return this.propertyFromPath(path, PropertyType.Boolean);
					};
					/**
					...
					*/
					ViewModelInstance.prototype.color = function(path) {
						return this.propertyFromPath(path, PropertyType.Color);
					};
					/**
					...
					*/
					ViewModelInstance.prototype.trigger = function(path) {
						return this.propertyFromPath(path, PropertyType.Trigger);
					};
					/**
					...
					*/
					ViewModelInstance.prototype.enum = function(path) {
						return this.propertyFromPath(path, PropertyType.Enum);
					};
					/**
					...
					*/
					ViewModelInstance.prototype.list = function(path) {
						return this.propertyFromPath(path, PropertyType.List);
					};
					/**
					...
					*/
					ViewModelInstance.prototype.image = function(path) {
						return this.propertyFromPath(path, PropertyType.Image);
					};
					/**
					* method to access a view model property instance belonging
					* to the view model instance or to a nested view model instance
					...
					*/
					ViewModelInstance.prototype.font = function(path) {
						return this.propertyFromPath(path, PropertyType.Font);
					};
					/**
					...
					*/
					ViewModelInstance.prototype.artboard = function(path) {
						return this.propertyFromPath(path, PropertyType.Artboard);
					};
					/**
					* method to access a view model property instance belonging
					* to the view model instance or to a nested view model instance
					...
					*/
					ViewModelInstance.prototype.viewModel = function(path) {
						...
						if (parentViewModelInstance != null) return parentViewModelInstance.internalViewModelInstance(pathSegments[pathSegments.length - 1]);
						return null;
					};
						...
						if (value.runtimeInstance !== null) {
							...
							if (result) {
								...
								if (oldInstance_1 !== null) {
									...
									if (this._children.includes(oldInstance_1)) this._children = this._children.filter(function(child) {
					...
					*/
					...
					ViewModelInstance.prototype.cleanup = function() {
						...
						if (this._referenceCount <= 0) {
							if (this.selfUnref) (_a = this._runtimeInstance) === null || _a === void 0 || _a.unref();
				...
				var ViewModelInstanceValue = function() {
					...
					ViewModelInstanceValue.prototype.off = function(callback) {
						...
						if (this.callbacks.length === 0) this._parentViewModel.removeFromPropertyCallbacks(this);
					};
					ViewModelInstanceValue.prototype.internalHandleCallback = function(callback) {};
					ViewModelInstanceValue.prototype.handleCallbacks = function() {
						var _this = this;
						if (this._viewModelInstanceValue.hasChanged) this.callbacks.forEach(function(callback) {
				...
				var ViewModelInstanceAssetFont = function(_super) {
				...
				var ViewModelInstanceArtboard = function(_super) {
					...
					Object.defineProperty(ViewModelInstanceArtboard.prototype, "value", {
						set: function(artboard) {
							...
							if (artboard.isBindableArtboard) bindableArtboard = artboard;
							else bindableArtboard = artboard.file.internalBindableArtboardFromArtboard(artboard.nativeArtboard);
							...
							if (bindableArtboard === null || bindableArtboard === void 0 ? void 0 : bindableArtboard.nativeViewModel) this._viewModelInstanceValue.viewModelInstance((_b = bindableArtboard === null || bindableArtboard === void 0 ? void 0 : bindableArtboard.nativeViewModel) !== null && _b !== void 0 ? _b : null);
						},
						enumerable: false,
						configurable: true
					});
					...
					return __awaiter(void 0, void 0, void 0, function() {
						...
						return __generator(this, function(_a) {
							switch (_a.label) {
								...
								case 1:
									res = _a.sent();
									if (!res.ok) throw new Error("Failed to fetch the Rive file: HTTP ".concat(res.status));
...
//#endregion
//#region node_modules/@rive-app/react-canvas/dist/index.js
var require_dist = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: !0 });
	var observer, React = require_react(), canvas = require_rive();
	...
	var MyResizeObserver = globalThis.ResizeObserver || FakeResizeObserver, useResizeObserver = void 0 !== globalThis.ResizeObserver, useWindowListener = !useResizeObserver;
	...
	function safeCleanup(e, t) {
		try {
			...
			console.warn("[Rive] " + e + " threw while cleaning up Rive; contained. ", t);
		}
	}
	function useResizeCanvas(e) {
		var t = e.riveLoaded, n = void 0 !== t && t, a = e.canvasElem, r = e.containerRef, u = e.options, i = e.onCanvasHasResized, o = e.artboardBounds, s = getOptions(void 0 === u ? {} : u), c = React.useState({
			...
			height: 0,
			width: 0
		}), b = p[0], h = b.height, R = b.width, g = p[1], w = React.useState(!0), y = w[0], m = w[1], V = s.fitCanvasToArtboardHeight, I = s.shouldResizeCanvasToContainer, C = s.useDevicePixelRatio, O = s.customDevicePixelRatio, M = useSize(r, I), x = useDevicePixelRatio(O), P = null != o ? o : {}, E = P.maxX, _ = P.maxY, k = React.useCallback(function() {
			...
			if (I && r.current && n) {
				...
				if (a) {
					...
					if (s.fitCanvasToArtboardHeight && c && (r.current.style.height = u + "px", o = !0), s.useDevicePixelRatio) {
						...
						if (c || l) {
							var p = x * t, b = x * u;
							a.width = p, a.height = b, a.style.width = t + "px", a.style.height = u + "px", g({
								width: p,
								height: b
							}), o = !0;
						}
	...
	var FakeIntersectionObserver = /* @__PURE__ */ function() {
		...
		function e() {
			var e = this;
			this.elementsMap = /* @__PURE__ */ new Map(), this.onObserved = function(t) {
	...
	function RiveComponent(e) {
		...
		return /* @__PURE__ */ React__default.default.createElement("div", _extends$2({
			ref: t,
			className: r
		}, !r && { style: s }), /* @__PURE__ */ React__default.default.createElement("canvas", _extends$2({
			ref: n,
			style: {
				verticalAlign: "top",
				width: 0,
	...
	function useRive(e, t) {
		...
		var g = useDevicePixelRatio(), w = React.useCallback(function() {
			if (f) {
				if (f.layout && f.layout.fit === canvas.Fit.Layout && u) {
					...
					f.devicePixelRatioUsed = g, f.artboardWidth = (null == u ? void 0 : u.width) / e, f.artboardHeight = (null == u ? void 0 : u.height) / e;
				}
		...
		var y = React.useCallback(function(e) {
			var t = s.current;
			null === e && t && (t.height = 0, t.width = 0), s.current = e, i(e);
		}, []);
		React.useEffect(function() {
			if (u && e) {
				var t, n = null != f;
				if (null == f) {
					var a = e.onRiveReady, r = _object_without_properties_loose$1(e, ["onRiveReady"]);
					t = new canvas.Rive(_extends$2({}, r, {
						useOffscreenRenderer: R,
						canvas: u
					})), null != c.current && safeCleanup("replacing a previous instance", function() {
						return c.current.cleanup();
					}), c.current = t, t.on(canvas.EventType.Load, function() {
						n = !0, a && a(t), u ? d(t) : safeCleanup("unmounted before load", function() {
							return t.cleanup();
						});
					});
				}
				return function() {
					n || safeCleanup("teardown before load", function() {
						return null == t ? void 0 : t.cleanup();
					});
				};
			}
		}, [
		...
		React.useEffect(function() {
			var e, t = !1, n = function() {
				if (u && t) {
					...
					e.width > 0 && e.height > 0 && e.top < (window.innerHeight || document.documentElement.clientHeight) && e.bottom > 0 && e.left < (window.innerWidth || document.documentElement.clientWidth) && e.right > 0 && (f?.startRendering(), t = !1);
				}
			};
			return u && !1 !== p.shouldUseIntersectionObserver && I(u, function(a) {
				a.isIntersecting ? f && f.startRendering() : f && f.stopRendering(), t = !a.isIntersecting, clearTimeout(e), a.isIntersecting || 0 !== a.boundingClientRect.width || (e = setTimeout(n, 10));
			}), function() {
				clearTimeout(e), u && C(u);
			};
		}, [
			I,
			C,
		...
		React.useEffect(function() {
			f && O && (f.isPlaying ? (f.stop(f.animationNames), f.play(O)) : f.isPaused && (f.stop(f.animationNames), f.pause(O)));
		}, [O, f]);
		var M = React.useCallback(function(e) {
			return /* @__PURE__ */ React__default.default.createElement(RiveComponent, _extends$2({
				setContainerRef: m,
				setCanvasRef: y
			}, e));
		}, [y, m]);
	...
	var Rive = function(e) {
		var t = e.src, n = e.artboard, a = e.stateMachine, r = e.animations, u = e.stateMachines, i = e.layout, o = e.useOffscreenRenderer, s = e.enableGPUCanvas, c = e.shouldDisableRiveListeners, l = e.shouldResizeCanvasToContainer, f = e.automaticallyHandleEvents, d = e.children, v = _object_without_properties_loose(e, [
			"src",
			"artboard",
			"stateMachine",
			"animations",
			...
			enableGPUCanvas: s
		}, _extends$1({ shouldResizeCanvasToContainer: void 0 === l || l }, void 0 !== o && { useOffscreenRenderer: o })).RiveComponent;
		return /* @__PURE__ */ React__default.default.createElement(p, v, d);
	};
	...
	function useViewModelInstance(e, t) {
		...
		return React.useEffect(function() {
			...
			var t = resolveViewModelInstance(e, {
				name: a,
				useNew: i
			});
			l(t), o && t && o.viewModelInstance !== t && (o.setViewModelInstance(t), scheduleBind(o));
		}, [
			e,
			a,
			void 0 !== r && r,
	...
	function useGlobalViewModelInstance(e, t, n) {
		...
		return React.useEffect(function() {
			var n = resolveViewModelInstance(e, {
				name: r,
				useNew: i,
				instance: o
			});
			f(n), s && t && n && s.setGlobalViewModelInstance(t, n) && scheduleBind(s);
		}, [
			e,
			t,
			r,
	...
	function useViewModelInstanceProperty(e, t, n) {
		...
		var h = React.useCallback(function(e) {
	...
	function useViewModelInstanceTrigger(e, t, n) {
		...
		return { trigger: useViewModelInstanceProperty(e, t, {
			getProperty: React.useCallback(function(e, t) {
				return e.trigger(t);
			}, []),
	...
	function useViewModelInstanceImage(e, t) {
		return { setValue: useViewModelInstanceProperty(e, t, {
			getProperty: React.useCallback(function(e, t) {
				return e.image(t);
			}, []),
			getValue: React.useCallback(function() {}, []),
